 ...
 */
public class FixedScriptDataAccessUtilKeyImpl extends ScriptDataAccessUtilLongKeyImpl {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public FixedScriptDataAccessUtilKeyImpl(BuriDataFieldType fieldType) {
        super(fieldType);
    }
