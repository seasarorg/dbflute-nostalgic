...
/**
 * The entity of BURI_ALL_ROUND_STATE as VIEW. <br />
 * <pre>
 * [primary-key]
 *     
 * 
 ...
 */
public abstract class BsBuriAllRoundState implements Entity, Serializable, Cloneable {
    ...
    //                                                                    Foreign Property
    //                                                                    ================
    /** DOCUMENT by my INTERNAL_PK_VALUE, named 'document'. */
    protected Document _document;

    /**
     * DOCUMENT by my INTERNAL_PK_VALUE, named 'document'. <br />
     * This relation is auto-detected as implicit reverse FK.
     * @return The entity of foreign property 'document'. (NullAllowed: If the foreign key does not have 'NotNull' constraint, please check null.)
     */
     ...
     * DOCUMENT by my INTERNAL_PK_VALUE, named 'document'. <br />
     * This relation is auto-detected as implicit reverse FK.
     * @param document The entity of foreign property 'document'. (NullAllowed)
     */
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsBuriAllRoundState)) { return false; }
        BsBuriAllRoundState otherEntity = (BsBuriAllRoundState)other;
    ...
    public String toStringWithRelation() {
        ...
        String l = "\n  ";
        if (_document != null)
        { sb.append(l).append(xbRDS(_document, "document")); }
        return sb.toString();
    }
    ...
    protected String buildRelationString() {
        StringBuilder sb = new StringBuilder();
        String c = ",";
        if (_document != null) { sb.append(c).append("document"); }
     ...
     */
    public BuriAllRoundState clone() {
        try {
            return (BuriAllRoundState)super.clone();
