...
/**
 * The entity of BURIPATHDATA as VIEW. <br />
 * <pre>
 * [primary-key]
 *     
 * 
 ...
 */
public abstract class BsBuriPathData implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsBuriPathData)) { return false; }
        BsBuriPathData otherEntity = (BsBuriPathData)other;
     ...
     */
    public BuriPathData clone() {
        try {
            return (BuriPathData)super.clone();
