...
/**
 * The entity of BURIPATHHISTORYDATAUSER as VIEW. <br />
 * <pre>
 * [primary-key]
 *     
 * 
 ...
 */
public abstract class BsBuriPathHistoryDataUser implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsBuriPathHistoryDataUser)) { return false; }
        BsBuriPathHistoryDataUser otherEntity = (BsBuriPathHistoryDataUser)other;
     ...
     */
    public BuriPathHistoryDataUser clone() {
        try {
            return (BuriPathHistoryDataUser)super.clone();
