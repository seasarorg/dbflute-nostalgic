...
/**
 * The DB meta of BURI_ALL_ROUND_STATE_HISTORY. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class BuriAllRoundStateHistoryDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final BuriAllRoundStateHistoryDbm _instance = new BuriAllRoundStateHistoryDbm();
    private BuriAllRoundStateHistoryDbm() {}
    public static BuriAllRoundStateHistoryDbm getInstance() { return _instance; }
    ...
    public static class EpgInternalStateId implements PropertyGateway {
        public Object read(Entity e) { return ((BuriAllRoundStateHistory)e).getInternalStateId(); }
        public void write(Entity e, Object v) { ((BuriAllRoundStateHistory)e).setInternalStateId(ctl(v)); }
    }
    public static class EpgStatusUpdateDatetime implements PropertyGateway {
        public Object read(Entity e) { return ((BuriAllRoundStateHistory)e).getStatusUpdateDatetime(); }
        public void write(Entity e, Object v) { ((BuriAllRoundStateHistory)e).setStatusUpdateDatetime((java.sql.Timestamp)v); }
    }
    public static class EpgParticipantName implements PropertyGateway {
        public Object read(Entity e) { return ((BuriAllRoundStateHistory)e).getParticipantName(); }
        public void write(Entity e, Object v) { ((BuriAllRoundStateHistory)e).setParticipantName((String)v); }
    }
    public static class EpgParticipantType implements PropertyGateway {
        public Object read(Entity e) { return ((BuriAllRoundStateHistory)e).getParticipantType(); }
        public void write(Entity e, Object v) { ((BuriAllRoundStateHistory)e).setParticipantType((String)v); }
    }
    public static class EpgInternalPathId implements PropertyGateway {
        public Object read(Entity e) { return ((BuriAllRoundStateHistory)e).getInternalPathId(); }
        public void write(Entity e, Object v) { ((BuriAllRoundStateHistory)e).setInternalPathId(ctl(v)); }
    }
    public static class EpgStatusPathName implements PropertyGateway {
        public Object read(Entity e) { return ((BuriAllRoundStateHistory)e).getStatusPathName(); }
        public void write(Entity e, Object v) { ((BuriAllRoundStateHistory)e).setStatusPathName((String)v); }
    }
    public static class EpgInternalDataId implements PropertyGateway {
        public Object read(Entity e) { return ((BuriAllRoundStateHistory)e).getInternalDataId(); }
        public void write(Entity e, Object v) { ((BuriAllRoundStateHistory)e).setInternalDataId(ctl(v)); }
    }
    public static class EpgInternalPkValue implements PropertyGateway {
        public Object read(Entity e) { return ((BuriAllRoundStateHistory)e).getInternalPkValue(); }
        public void write(Entity e, Object v) { ((BuriAllRoundStateHistory)e).setInternalPkValue(ctl(v)); }
    }
    public static class EpgInternalDataType implements PropertyGateway {
        public Object read(Entity e) { return ((BuriAllRoundStateHistory)e).getInternalDataType(); }
        public void write(Entity e, Object v) { ((BuriAllRoundStateHistory)e).setInternalDataType((String)v); }
    }
    public static class EpgInternalUserId implements PropertyGateway {
        public Object read(Entity e) { return ((BuriAllRoundStateHistory)e).getInternalUserId(); }
        public void write(Entity e, Object v) { ((BuriAllRoundStateHistory)e).setInternalUserId(ctl(v)); }
    }
    public static class EpgStatusUpdateUser implements PropertyGateway {
        public Object read(Entity e) { return ((BuriAllRoundStateHistory)e).getStatusUpdateUser(); }
        public void write(Entity e, Object v) { ((BuriAllRoundStateHistory)e).setStatusUpdateUser((String)v); }
    }

    // ===================================================================================
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "BURI_ALL_ROUND_STATE_HISTORY";
    protected final String _tablePropertyName = "buriAllRoundStateHistory";
    protected final TableSqlName _tableSqlName = new TableSqlName("BURI_ALL_ROUND_STATE_HISTORY", _tableDbName);
    ...
    protected final ColumnInfo _columnInternalPkValue = cci("INTERNAL_PK_VALUE", "INTERNAL_PK_VALUE", null, null, false, "internalPkValue", Long.class, false, false, "NUMBER", 18, 0, null, false, null, null, "document_文書管理_文書公開", null, null);
    ...
    //                                      Foreign Property
    //                                      ----------------
    public ForeignInfo foreignDocument_文書管理_文書公開() {
        Map<ColumnInfo, ColumnInfo> map = newLinkedHashMap(columnInternalPkValue(), DocumentDbm.getInstance().columnId());
        return cfi("FK_BURI_ALL_ROUND_STATE_HISTORY_DOCUMENT_1", "document_文書管理_文書公開", this, DocumentDbm.getInstance(), map, 0, false, false, false, true, "$$localAlias$$.INTERNAL_DATA_TYPE = 'com.example.dbflute.buri.dbflute.exentity.Document'", false, null);
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.buri.dbflute.exentity.BuriAllRoundStateHistory"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.buri.dbflute.cbean.BuriAllRoundStateHistoryCB"; }
    public String getDaoTypeName() { return "${glPackageExtendedDao}.BuriAllRoundStateHistoryDao"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.buri.dbflute.exbhv.BuriAllRoundStateHistoryBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<BuriAllRoundStateHistory> getEntityType() { return BuriAllRoundStateHistory.class; }
    ...
    { doAcceptPrimaryKeyMap((BuriAllRoundStateHistory)e, m); }
    public void acceptAllColumnMap(Entity e, Map<String, ? extends Object> m)
    { doAcceptAllColumnMap((BuriAllRoundStateHistory)e, m); }
