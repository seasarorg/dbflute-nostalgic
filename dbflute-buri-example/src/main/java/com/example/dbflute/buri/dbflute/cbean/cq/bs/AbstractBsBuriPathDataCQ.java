...
/**
 * The abstract condition-query of BURIPATHDATA.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsBuriPathDataCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsBuriPathDataCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    protected String xabCB() { return BuriPathDataCB.class.getName(); }
    protected String xabCQ() { return BuriPathDataCQ.class.getName(); }
