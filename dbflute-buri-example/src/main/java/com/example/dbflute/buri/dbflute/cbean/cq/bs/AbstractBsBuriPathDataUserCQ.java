...
/**
 * The abstract condition-query of BURIPATHDATAUSER.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsBuriPathDataUserCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsBuriPathDataUserCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    protected String xabCB() { return BuriPathDataUserCB.class.getName(); }
    protected String xabCQ() { return BuriPathDataUserCQ.class.getName(); }
