...
/**
 * The abstract condition-query of BURIPATHHISTORYDATAUSER.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsBuriPathHistoryDataUserCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsBuriPathHistoryDataUserCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    protected String xabCB() { return BuriPathHistoryDataUserCB.class.getName(); }
    protected String xabCQ() { return BuriPathHistoryDataUserCQ.class.getName(); }
