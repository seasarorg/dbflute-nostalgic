...
/**
 * The abstract condition-query of BURISTATEUNDOLOG.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsBuriStateUndoLogCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsBuriStateUndoLogCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param stateUndoLogId The value of stateUndoLogId as equal.
     */
    public void setStateUndoLogId_Equal(Long stateUndoLogId) {
        doSetStateUndoLogId_Equal(stateUndoLogId);
    }

    protected void doSetStateUndoLogId_Equal(Long stateUndoLogId) {
        regStateUndoLogId(CK_EQ, stateUndoLogId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br />
     * STATEUNDOLOGID: {PK, NotNull, NUMBER(18)}
     * @param stateUndoLogId The value of stateUndoLogId as greaterThan.
     */
    public void setStateUndoLogId_GreaterThan(Long stateUndoLogId) {
        regStateUndoLogId(CK_GT, stateUndoLogId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br />
     * STATEUNDOLOGID: {PK, NotNull, NUMBER(18)}
     * @param stateUndoLogId The value of stateUndoLogId as lessThan.
     */
    public void setStateUndoLogId_LessThan(Long stateUndoLogId) {
        regStateUndoLogId(CK_LT, stateUndoLogId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br />
     * STATEUNDOLOGID: {PK, NotNull, NUMBER(18)}
     * @param stateUndoLogId The value of stateUndoLogId as greaterEqual.
     */
    public void setStateUndoLogId_GreaterEqual(Long stateUndoLogId) {
        regStateUndoLogId(CK_GE, stateUndoLogId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br />
     * STATEUNDOLOGID: {PK, NotNull, NUMBER(18)}
     * @param stateUndoLogId The value of stateUndoLogId as lessEqual.
     */
    public void setStateUndoLogId_LessEqual(Long stateUndoLogId) {
        regStateUndoLogId(CK_LE, stateUndoLogId);
    }
     ...
     * STATEUNDOLOGID: {PK, NotNull, NUMBER(18)}
     * @param minNumber The min number of stateUndoLogId. (NullAllowed)
     * @param maxNumber The max number of stateUndoLogId. (NullAllowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setStateUndoLogId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, getCValueStateUndoLogId(), "STATEUNDOLOGID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br />
     * STATEUNDOLOGID: {PK, NotNull, NUMBER(18)}
     * @param stateUndoLogIdList The collection of stateUndoLogId as inScope.
     */
    public void setStateUndoLogId_InScope(Collection<Long> stateUndoLogIdList) {
        doSetStateUndoLogId_InScope(stateUndoLogIdList);
    }

    protected void doSetStateUndoLogId_InScope(Collection<Long> stateUndoLogIdList) {
        regINS(CK_INS, cTL(stateUndoLogIdList), getCValueStateUndoLogId(), "STATEUNDOLOGID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br />
     * STATEUNDOLOGID: {PK, NotNull, NUMBER(18)}
     * @param stateUndoLogIdList The collection of stateUndoLogId as notInScope.
     */
    public void setStateUndoLogId_NotInScope(Collection<Long> stateUndoLogIdList) {
        doSetStateUndoLogId_NotInScope(stateUndoLogIdList);
    }

    protected void doSetStateUndoLogId_NotInScope(Collection<Long> stateUndoLogIdList) {
        regINS(CK_NINS, cTL(stateUndoLogIdList), getCValueStateUndoLogId(), "STATEUNDOLOGID");
    }
     ...
     * STATEUNDOLOGID: {PK, NotNull, NUMBER(18)}
     */
    public void setStateUndoLogId_IsNull() { regStateUndoLogId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br />
     * STATEUNDOLOGID: {PK, NotNull, NUMBER(18)}
     */
    public void setStateUndoLogId_IsNotNull() { regStateUndoLogId(CK_ISNN, DOBJ); }

    protected void regStateUndoLogId(ConditionKey k, Object v) { regQ(k, v, getCValueStateUndoLogId(), "STATEUNDOLOGID"); }
    abstract protected ConditionValue getCValueStateUndoLogId();
     ...
     * AUTORUNTIME: {TIMESTAMP(6)(11, 6)}
     */
    public void setAutoRunTime_IsNull() { regAutoRunTime(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br />
     * AUTORUNTIME: {TIMESTAMP(6)(11, 6)}
     */
    public void setAutoRunTime_IsNotNull() { regAutoRunTime(CK_ISNN, DOBJ); }
     ...
     * @param createBtid The value of createBtid as equal.
     */
    public void setCreateBtid_Equal(Long createBtid) {
        doSetCreateBtid_Equal(createBtid);
    }

    protected void doSetCreateBtid_Equal(Long createBtid) {
        regCreateBtid(CK_EQ, createBtid);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br />
     * CREATEBTID: {NotNull, NUMBER(18)}
     * @param createBtid The value of createBtid as greaterThan.
     */
    public void setCreateBtid_GreaterThan(Long createBtid) {
        regCreateBtid(CK_GT, createBtid);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br />
     * CREATEBTID: {NotNull, NUMBER(18)}
     * @param createBtid The value of createBtid as lessThan.
     */
    public void setCreateBtid_LessThan(Long createBtid) {
        regCreateBtid(CK_LT, createBtid);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br />
     * CREATEBTID: {NotNull, NUMBER(18)}
     * @param createBtid The value of createBtid as greaterEqual.
     */
    public void setCreateBtid_GreaterEqual(Long createBtid) {
        regCreateBtid(CK_GE, createBtid);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br />
     * CREATEBTID: {NotNull, NUMBER(18)}
     * @param createBtid The value of createBtid as lessEqual.
     */
    public void setCreateBtid_LessEqual(Long createBtid) {
        regCreateBtid(CK_LE, createBtid);
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * CREATEBTID: {NotNull, NUMBER(18)}
     * @param minNumber The min number of createBtid. (NullAllowed)
     * @param maxNumber The max number of createBtid. (NullAllowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setCreateBtid_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, getCValueCreateBtid(), "CREATEBTID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br />
     * CREATEBTID: {NotNull, NUMBER(18)}
     * @param createBtidList The collection of createBtid as inScope.
     */
    public void setCreateBtid_InScope(Collection<Long> createBtidList) {
        doSetCreateBtid_InScope(createBtidList);
    }

    protected void doSetCreateBtid_InScope(Collection<Long> createBtidList) {
        regINS(CK_INS, cTL(createBtidList), getCValueCreateBtid(), "CREATEBTID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br />
     * CREATEBTID: {NotNull, NUMBER(18)}
     * @param createBtidList The collection of createBtid as notInScope.
     */
    public void setCreateBtid_NotInScope(Collection<Long> createBtidList) {
        doSetCreateBtid_NotInScope(createBtidList);
    }

    protected void doSetCreateBtid_NotInScope(Collection<Long> createBtidList) {
        regINS(CK_NINS, cTL(createBtidList), getCValueCreateBtid(), "CREATEBTID");
    }

    protected void regCreateBtid(ConditionKey k, Object v) { regQ(k, v, getCValueCreateBtid(), "CREATEBTID"); }
    abstract protected ConditionValue getCValueCreateBtid();
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_Equal()</span>.max(new SubQuery&lt;BuriStateUndoLogCB&gt;() {
     *     public void query(BuriStateUndoLogCB subCB) {
     ...
     */
    public HpSSQFunction<BuriStateUndoLogCB> scalar_Equal() {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;BuriStateUndoLogCB&gt;() {
     *     public void query(BuriStateUndoLogCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<BuriStateUndoLogCB> scalar_NotEqual() {
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;BuriStateUndoLogCB&gt;() {
     *     public void query(BuriStateUndoLogCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<BuriStateUndoLogCB> scalar_GreaterThan() {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessThan()</span>.max(new SubQuery&lt;BuriStateUndoLogCB&gt;() {
     *     public void query(BuriStateUndoLogCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<BuriStateUndoLogCB> scalar_LessThan() {
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;BuriStateUndoLogCB&gt;() {
     *     public void query(BuriStateUndoLogCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<BuriStateUndoLogCB> scalar_GreaterEqual() {
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;BuriStateUndoLogCB&gt;() {
     *     public void query(BuriStateUndoLogCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<BuriStateUndoLogCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE.getOperand());
    }

    protected HpSSQFunction<BuriStateUndoLogCB> xcreateSSQFunction(final String operand) {
        return new HpSSQFunction<BuriStateUndoLogCB>(new HpSSQSetupper<BuriStateUndoLogCB>() {
            public void setup(String function, SubQuery<BuriStateUndoLogCB> subQuery, HpSSQOption<BuriStateUndoLogCB> option) {
                xscalarCondition(function, subQuery, operand, option);
            }
        });
    }

    protected void xscalarCondition(String function, SubQuery<BuriStateUndoLogCB> subQuery, String operand, HpSSQOption<BuriStateUndoLogCB> option) {
        assertObjectNotNull("subQuery<BuriStateUndoLogCB>", subQuery);
        BuriStateUndoLogCB cb = xcreateScalarConditionCB(); subQuery.query(cb);
        String subQueryPropertyName = keepScalarCondition(cb.query()); // for saving query-value
        option.setPartitionByCBean(xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(function, cb.query(), subQueryPropertyName, operand, option);
    }
    public abstract String keepScalarCondition(BuriStateUndoLogCQ subQuery);

    protected BuriStateUndoLogCB xcreateScalarConditionCB() {
        BuriStateUndoLogCB cb = new BuriStateUndoLogCB();
        cb.xsetupForScalarCondition(this);
        return cb;
    }

    protected BuriStateUndoLogCB xcreateScalarConditionPartitionByCB() {
        BuriStateUndoLogCB cb = new BuriStateUndoLogCB();
    ...
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String function, SubQuery<BuriStateUndoLogCB> subQuery, String aliasName, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<BuriStateUndoLogCB>", subQuery);
        BuriStateUndoLogCB cb = new BuriStateUndoLogCB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
        String subQueryPropertyName = keepSpecifyMyselfDerived(cb.query()); // for saving query-value.
        registerSpecifyMyselfDerived(function, cb.query(), "STATEUNDOLOGID", "STATEUNDOLOGID", subQueryPropertyName, "myselfDerived", aliasName, option);
    }
    public abstract String keepSpecifyMyselfDerived(BuriStateUndoLogCQ subQuery);

    /**
     * Prepare for (Query)MyselfDerived (SubQuery).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<BuriStateUndoLogCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived();
    }
    protected HpQDRFunction<BuriStateUndoLogCB> xcreateQDRFunctionMyselfDerived() {
        return new HpQDRFunction<BuriStateUndoLogCB>(new HpQDRSetupper<BuriStateUndoLogCB>() {
            public void setup(String function, SubQuery<BuriStateUndoLogCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
                xqderiveMyselfDerived(function, subQuery, operand, value, option);
            }
        });
    }
    public void xqderiveMyselfDerived(String function, SubQuery<BuriStateUndoLogCB> subQuery, String operand, Object value, DerivedReferrerOption option) {
        assertObjectNotNull("subQuery<BuriStateUndoLogCB>", subQuery);
        BuriStateUndoLogCB cb = new BuriStateUndoLogCB(); cb.xsetupForDerivedReferrer(this); subQuery.query(cb);
        String subQueryPropertyName = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String parameterPropertyName = keepQueryMyselfDerivedParameter(value);
        registerQueryMyselfDerived(function, cb.query(), "STATEUNDOLOGID", "STATEUNDOLOGID", subQueryPropertyName, "myselfDerived", operand, value, parameterPropertyName, option);
    }
    public abstract String keepQueryMyselfDerived(BuriStateUndoLogCQ subQuery);
     ...
     */
    public void myselfExists(SubQuery<BuriStateUndoLogCB> subQuery) {
        assertObjectNotNull("subQuery<BuriStateUndoLogCB>", subQuery);
        BuriStateUndoLogCB cb = new BuriStateUndoLogCB(); cb.xsetupForMyselfExists(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfExists(cb.query()); // for saving query-value.
        registerMyselfExists(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfExists(BuriStateUndoLogCQ subQuery);
     ...
     * @param subQuery The implementation of sub query. (NotNull)
     */
    public void myselfInScope(SubQuery<BuriStateUndoLogCB> subQuery) {
        assertObjectNotNull("subQuery<BuriStateUndoLogCB>", subQuery);
        BuriStateUndoLogCB cb = new BuriStateUndoLogCB(); cb.xsetupForMyselfInScope(this); subQuery.query(cb);
        String subQueryPropertyName = keepMyselfInScope(cb.query()); // for saving query-value.
        registerMyselfInScope(cb.query(), subQueryPropertyName);
    }
    public abstract String keepMyselfInScope(BuriStateUndoLogCQ subQuery);

    // ===================================================================================
    //                                                                       Very Internal
    //                                                                       =============
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabCB() { return BuriStateUndoLogCB.class.getName(); }
    protected String xabCQ() { return BuriStateUndoLogCQ.class.getName(); }
