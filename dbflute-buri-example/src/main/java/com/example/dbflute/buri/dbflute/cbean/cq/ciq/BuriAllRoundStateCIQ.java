...
/**
 * The condition-query for in-line of BURI_ALL_ROUND_STATE.
 * @author DBFlute(AutoGenerator)
 */
public class BuriAllRoundStateCIQ extends AbstractBsBuriAllRoundStateCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsBuriAllRoundStateCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BuriAllRoundStateCIQ(ConditionQuery childQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsBuriAllRoundStateCQ myCQ) {
    ...
    public String keepInternalPkValue_InScopeRelation_Document(DocumentCQ sq)
    { return _myCQ.keepInternalPkValue_InScopeRelation_Document(sq); }
    public String keepInternalPkValue_NotInScopeRelation_Document(DocumentCQ sq)
    { return _myCQ.keepInternalPkValue_NotInScopeRelation_Document(sq); }
    ...
    protected String xinCB() { return BuriAllRoundStateCB.class.getName(); }
    protected String xinCQ() { return BuriAllRoundStateCQ.class.getName(); }
}
