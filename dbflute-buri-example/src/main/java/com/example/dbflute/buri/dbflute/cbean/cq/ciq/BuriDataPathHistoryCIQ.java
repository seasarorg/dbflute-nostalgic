...
/**
 * The condition-query for in-line of BURIDATAPATHHISTORY.
 * @author DBFlute(AutoGenerator)
 */
public class BuriDataPathHistoryCIQ extends AbstractBsBuriDataPathHistoryCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsBuriDataPathHistoryCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BuriDataPathHistoryCIQ(ConditionQuery childQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsBuriDataPathHistoryCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue getCValueHistoryId() { return _myCQ.getHistoryId(); }
    ...
    protected ConditionValue getCValueAction() { return _myCQ.getAction(); }
    ...
    protected String xinCB() { return BuriDataPathHistoryCB.class.getName(); }
    protected String xinCQ() { return BuriDataPathHistoryCQ.class.getName(); }
}
