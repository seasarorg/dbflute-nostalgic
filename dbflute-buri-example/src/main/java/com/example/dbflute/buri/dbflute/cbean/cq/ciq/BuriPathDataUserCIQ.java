...
/**
 * The condition-query for in-line of BURIPATHDATAUSER.
 * @author DBFlute(AutoGenerator)
 */
public class BuriPathDataUserCIQ extends AbstractBsBuriPathDataUserCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsBuriPathDataUserCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BuriPathDataUserCIQ(ConditionQuery childQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsBuriPathDataUserCQ myCQ) {
    ...
    protected String xinCB() { return BuriPathDataUserCB.class.getName(); }
    protected String xinCQ() { return BuriPathDataUserCQ.class.getName(); }
}
