...
/**
 * The condition-query for in-line of BURIPATHHISTORYDATAUSER.
 * @author DBFlute(AutoGenerator)
 */
public class BuriPathHistoryDataUserCIQ extends AbstractBsBuriPathHistoryDataUserCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsBuriPathHistoryDataUserCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BuriPathHistoryDataUserCIQ(ConditionQuery childQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsBuriPathHistoryDataUserCQ myCQ) {
    ...
    protected String xinCB() { return BuriPathHistoryDataUserCB.class.getName(); }
    protected String xinCQ() { return BuriPathHistoryDataUserCQ.class.getName(); }
}
