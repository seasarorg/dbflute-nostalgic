 ...
 */
public class LdAccessContext {

    // ===================================================================================
    //                                                                        Thread Local
    //                                                                        ============
    /** The thread-local for this. */
    private static final ThreadLocal<LdAccessContext> _threadLocal = new ThreadLocal<LdAccessContext>();

    /**
     * Get access-context on thread.
     * @return The context of DB access.. (Nullable)
     */
    public static LdAccessContext getAccessContextOnThread() {
        return (LdAccessContext) _threadLocal.get();
    }
     ...
     */
    public static void setAccessContextOnThread(LdAccessContext accessContext) {
    ...
    public static String getAccessUserOnThread() {
        if (isExistAccessContextOnThread()) {
            final LdAccessContext userContextOnThread = getAccessContextOnThread();
