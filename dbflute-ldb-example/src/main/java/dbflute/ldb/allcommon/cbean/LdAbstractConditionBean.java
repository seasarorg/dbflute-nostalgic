...
import dbflute.ldb.allcommon.cbean.sqlclause.LdWhereClauseSimpleFilter;
...
public abstract class LdAbstractConditionBean implements LdConditionBean {
     ...
     * @return SQL clause. (NotNull)
     */
    protected abstract LdSqlClause createSqlClause();
    ...
    public LdConditionBean xsetupSelectCountIgnoreFetchScope() {
        ...
        getSqlClause().classifySelectClauseType(LdSqlClause.SelectClauseType.COUNT);
        getSqlClause().ignoreOrderBy();
    ...
    //                                                                             Specify
    //                                                                             =======
    protected static abstract class AbstractSpecification<CQ extends LdConditionQuery> {
        protected LdConditionBean _baseCB;
         ...
         */
        protected AbstractSpecification(LdConditionBean baseCB, SpQyCall<CQ> qyCall
    ...
    protected static interface SpQyCall<CQ extends LdConditionQuery> {
        public boolean has(); 
        public CQ qy(); 
    }
    ...
    public static class RAFunction<REFERRER_CB extends LdConditionBean, LOCAL_CQ extends LdConditionQuery> {
        protected LdConditionBean _baseCB;
        protected LOCAL_CQ _localCQ;
        protected RAQSetupper<REFERRER_CB, LOCAL_CQ> _querySetupper;
        protected LdDBMetaProvider _dbmetaProvider;

        public RAFunction(LdConditionBean baseCB
                        , LOCAL_CQ localCQ
         ...
         */
        public void count(LdSubQuery<REFERRER_CB> subQuery, String aliasName) {
         ...
         * @param aliasName The alias of the name. The property should exists on the entity. (NotNull)
         */
        public void countDistinct(LdSubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
         ...
         * @param aliasName The alias of the name. The property should exists on the entity. (NotNull)
         */
        public void max(LdSubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
         ...
         * @param aliasName The alias of the name. The property should exists on the entity. (NotNull)
         */
        public void min(LdSubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
         ...
         * @param aliasName The alias of the name. The property should exists on the entity. (NotNull)
         */
        public void sum(LdSubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
         ...
         * @param aliasName The alias of the name. The property should exists on the entity. (NotNull)
         */
        public void avg(LdSubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
        ...
        protected void assertAliasName(String aliasName) {
            ...
            LdDBMeta dbmeta = _dbmetaProvider.provideDBMetaChecked(tableDbName);
    ...
    public static interface RAQSetupper<REFERRER_CB extends LdConditionBean, LOCAL_CQ extends LdConditionQuery> {
        public void setup(String function, LdSubQuery<REFERRER_CB> subQuery, LOCAL_CQ cq, String aliasName);
    }
    ...
    public String toDisplaySql() {
        return LdConditionBeanContext.convertConditionBean2DisplaySql(this, getLogDateFormat(), getLogTimestampFormat());
    }
    ...
    protected void assertPrimaryKeyMap(Map<String, ? extends Object> primaryKeyMap) {
        ...
        LdDBMeta dbmeta = getDBMetaProvider().provideDBMetaChecked(getTableDbName());
        List<LdColumnInfo> columnInfoList = dbmeta.getPrimaryUniqueInfo().getUniqueColumnList();
