...
import dbflute.ldb.allcommon.util.LdSimpleResourceUtil;
 ...
 */
public class LdOutsideSqlContext {

    /** Log instance. */
    private static final Log _log = LogFactory.getLog(LdOutsideSqlContext.class);
    
    // ===================================================================================
    //                                                                        Thread Local
    //                                                                        ============
    /** The thread-local for this. */
    private static final ThreadLocal<LdOutsideSqlContext> _threadLocal = new ThreadLocal<LdOutsideSqlContext>();

    /**
     * Get outside-SQL context on thread.
     * @return The context of outside-SQL. (Nullable)
     */
    public static LdOutsideSqlContext getOutsideSqlContextOnThread() {
        return (LdOutsideSqlContext)_threadLocal.get();
    }
     ...
     */
    public static void setOutsideSqlContextOnThread(LdOutsideSqlContext outsideSqlContext) {
    ...
    //                                                                          Unique Key
    //                                                                          ==========
    public static String generateSpecifiedOutsideSqlUniqueKey(String methodName, String path, Object pmb, LdOutsideSqlOption option, Object resultTypeSpecification) {
    ...
    public static void throwOutsideSqlNotFoundException(String path) {
        ...
        msg = msg + "* * * * * * * * * */" + getLineSeparator();
        throw new dbflute.ldb.allcommon.exception.LdOutsideSqlNotFoundException(msg);
    }
    ...
    protected final LdDBMetaProvider _dbmetaProvider;
     ...
     */
    public LdOutsideSqlContext(LdDBMetaProvider dbmetaProvider, String outsideSqlPackage) {
     ...
     * @exception dbflute.ldb.allcommon.exception.LdOutsideSqlNotFoundException When the SQL is not found.
     */
    ...
    protected String buildBehaviorSqlPackageName() {
        final LdDBMeta dbmeta = _dbmetaProvider.provideDBMetaChecked(_tableDbName);
    ...
    protected boolean isExistResource(String path) {
        return LdSimpleResourceUtil.isExist(path);
    }

    protected String readText(final String path, String sqlFileEncoding) {
        final InputStream ins = LdSimpleResourceUtil.getResourceStream(path);
    ...
    public LdCursorHandler getCursorHandler() {
