 ...
 */
public class LdPageNumberLink implements java.io.Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LdPageNumberLink() {
    }

    // ===================================================================================
    //                                                                         Initializer
    //                                                                         ===========
    public LdPageNumberLink initialize(int pageNumberElement, boolean current, String pageNumberLinkHref) {
