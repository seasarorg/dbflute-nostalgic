 ...
 */
package dbflute.ldb.allcommon.cbean.pagenavi.group;
 ...
 */
public class LdPageGroupBean implements java.io.Serializable {
     ...
     */
    public <LINK extends LdPageNumberLink> List<LINK> buildPageNumberLinkList(LdPageNumberLinkSetupper<LINK> pageNumberLinkSetupper) {
