...
public abstract class LdAbstractSqlClause implements LdSqlClause {
    ...
    protected List<LdWhereClauseSimpleFilter> _whereClauseSimpleFilterList;
    ...
    public LdSqlClause provider(LdDBMetaProvider dbmetaProvider) {
    ...
    public String getSelectClause() {
        ...
        // - - - - - - - - - -/
        StringBuilder sb = new StringBuilder();
        LdDBMeta dbmeta = findDBMeta(_tableName);
        List<LdColumnInfo> columnInfoList = dbmeta.getColumnInfoList();
    ...
    protected Map<String, SelectedSelectColumnInfo> createSelectedSelectColumnInfo(String foreignTableAliasName
                                                                                 ...
                                                                                 , String foreignPropertyName
                                                                                 , String localRelationPath) {
        final LdDBMeta dbmeta = findDBMeta(localTableName);
        final LdForeignInfo foreignInfo = dbmeta.findForeignInfo(foreignPropertyName);
        ...
        final LdDBMeta foreignDBMeta = foreignInfo.getForeignDBMeta();
        final List<LdColumnInfo> columnInfoList = foreignDBMeta.getColumnInfoList();
        for (LdColumnInfo columnInfo : columnInfoList) {
    ...
    protected LdOrderByClause.OrderByNullsSetupper createOrderByNullsSetupper() {// As Default
        return new LdOrderByClause.OrderByNullsSetupper() {
    ...
    protected LdOrderByClause.OrderByNullsSetupper createOrderByNullsSetupperByCaseWhen() {// Helper For Nulls Unsupported Database
        return new LdOrderByClause.OrderByNullsSetupper() {
            public String setup(String columnName, String orderByElementClause, boolean nullsFirst) {
    ...
    public void addWhereClauseSimpleFilter(LdWhereClauseSimpleFilter whereClauseSimpleFilter) {
        if (_whereClauseSimpleFilterList == null) {
            _whereClauseSimpleFilterList = new ArrayList<LdWhereClauseSimpleFilter>();
        }
    ...
    protected String filterWhereClauseSimply(String clauseElement) {
        ...
        for (final Iterator<LdWhereClauseSimpleFilter> ite = _whereClauseSimpleFilterList.iterator(); ite.hasNext(); ) {
            final LdWhereClauseSimpleFilter filter = ite.next();
            if (filter == null) {
    ...
    public String getClauseQueryUpdate(Map<String, String> columnParameterMap) {
        ...
        final LdDBMeta dbmeta = findDBMeta(_tableName);
    ...
    //                                                                       Assist Helper
    //                                                                       =============
    protected LdDBMeta findDBMeta(String tableName) {
