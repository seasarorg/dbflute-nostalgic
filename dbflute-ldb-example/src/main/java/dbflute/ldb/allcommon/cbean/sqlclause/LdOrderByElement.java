 ...
 */
public class LdOrderByElement implements Serializable {
	...
	protected LdOrderByClause.OrderByNullsSetupper _orderByNullsSetupper;
    ...
    public void setOrderByNullsSetupper(LdOrderByClause.OrderByNullsSetupper value, boolean nullsFirst) {
