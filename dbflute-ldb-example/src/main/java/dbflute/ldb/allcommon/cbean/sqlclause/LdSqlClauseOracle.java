 ...
 */
public class LdSqlClauseOracle extends LdAbstractSqlClause {
     ...
     **/
    public LdSqlClauseOracle(String tableName) {
        super(tableName);
    }
    ...
    public LdSqlClause lockForUpdate() {
        ...
        if (dbmeta.hasPrimaryKey()) {
            ...
            final String randomColumnName = ((LdColumnInfo)dbmeta.getColumnInfoList().get(0)).getColumnDbName();
