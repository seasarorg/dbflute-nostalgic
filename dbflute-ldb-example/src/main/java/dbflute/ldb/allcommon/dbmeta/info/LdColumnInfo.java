...
import dbflute.ldb.allcommon.dbmeta.LdDBMeta.OptimisticLockType;

/**
 * The information of column.
 * @author DBFlute(AutoGenerator)
 */
public class LdColumnInfo {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LdColumnInfo(LdDBMeta dbmeta, String columnDbName, String columnAlias, String propertyName
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof LdColumnInfo)) {
            return false;
        }
        final LdColumnInfo target = (LdColumnInfo)obj;
