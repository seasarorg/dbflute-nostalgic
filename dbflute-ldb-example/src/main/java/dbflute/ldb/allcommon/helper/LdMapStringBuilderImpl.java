 ...
 */
public class LdMapStringBuilderImpl implements LdMapStringBuilder {
    ...
    protected List<String> tokenize(String value, String delimiter) {
        final LdLineToken lineToken = new LdLineTokenImpl();
        final LdLineTokenizingOption lineTokenizingOption = new LdLineTokenizingOption();
