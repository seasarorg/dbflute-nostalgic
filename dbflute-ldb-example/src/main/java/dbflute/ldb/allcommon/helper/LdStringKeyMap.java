 ...
 */
public class LdStringKeyMap<VALUE> implements Map<String, VALUE> {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    protected LdStringKeyMap(boolean removeUnderscore, boolean concurrent) {
    ...
    public static <VALUE> LdStringKeyMap<VALUE> createAsFlexible() {
        return new LdStringKeyMap<VALUE>(true, false);
    }

    public static <VALUE> LdStringKeyMap<VALUE> createAsFlexibleConcurrent() {
        return new LdStringKeyMap<VALUE>(true, true);
    }

    public static <VALUE> LdStringKeyMap<VALUE> createAsCaseInsensitive() {
        return new LdStringKeyMap<VALUE>(false, false);
    }

    public static <VALUE> LdStringKeyMap<VALUE> createAsCaseInsensitiveConcurrent() {
        return new LdStringKeyMap<VALUE>(false, true);
    }
