...
import dbflute.ldb.allcommon.helper.collection.order.LdAccordingToOrder;
 ...
 */
public class LdAccordingToOrderImpl implements LdAccordingToOrder {
     ...
     */
    public <ELEMENT_TYPE, ID_TYPE> void order(final List<ELEMENT_TYPE> unorderedList, final LdAccordingToOrderOption<ELEMENT_TYPE, ID_TYPE> option) {
        ...
        final LdAccordingToOrderIdExtractor<ELEMENT_TYPE, ID_TYPE> idExtractor = option.getIdExtractor();
