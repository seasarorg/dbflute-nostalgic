...
import dbflute.ldb.allcommon.helper.token.line.impl.LdLineTokenImpl;

/**
 * @author DBFlute(AutoGenerator)
 */
public class LdFileTokenImpl implements LdFileToken {

    // =====================================================================================
    //                                                                             Attribute
    //                                                                             =========
    /** Line-token for help. */
    protected final LdLineToken _lineToken = new LdLineTokenImpl();
     ...
     */
    public void tokenize(String filename, LdFileTokenizingCallback fileTokenizingCallback, LdFileTokenizingOption fileTokenizingOption) throws java.io.FileNotFoundException, java.io.IOException {
     ...
     * @throws java.io.IOException
     */
    public void tokenize(java.io.InputStream inputStream, LdFileTokenizingCallback fileTokenizingCallback, LdFileTokenizingOption fileTokenizingOption) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        try {
            ...
            LdFileTokenizingHeaderInfo fileTokenizingHeaderInfo = null;
            int count = -1;
            int rowNumber = 1;
            int lineNumber = 0;
            while (true) {
                ...
                if (count == 0) {
                    if (fileTokenizingOption.isBeginFirstLine()) {
                        fileTokenizingHeaderInfo = new LdFileTokenizingHeaderInfo();// As empty
                    } else {
                ...
                try {
                    final LdFileTokenizingRowResource fileTokenizingRowResource = new LdFileTokenizingRowResource();
    ...
    protected LdFileTokenizingHeaderInfo analyzeHeaderInfo(String delimiter, final String lineString) {
        ...
        final LdFileTokenizingHeaderInfo fileTokenizingHeaderInfo = new LdFileTokenizingHeaderInfo();
     ...
     * @throws java.io.IOException
     */
    public void make(String filename, LdFileMakingCallback fileMakingCallback, LdFileMakingOption fileMakingOption) throws java.io.FileNotFoundException, java.io.IOException {
        assertStringNotNullAndNotTrimmedEmpty("filename", filename);
     ...
     * @throws java.io.IOException
     */
    public void make(java.io.OutputStream outputStream, LdFileMakingCallback fileMakingCallback, LdFileMakingOption fileMakingOption) throws java.io.FileNotFoundException, java.io.IOException {
        ...
        try {
            ...
            // Make header.
            final LdFileMakingHeaderInfo fileMakingHeaderInfo = fileMakingOption.getFileMakingHeaderInfo();
            ...
            // Make row.
            LdFileMakingRowResource rowResource = null;
            while (true) {
