 ...
 */
public abstract class LdCommonColumnSetupAbstractInterceptor extends org.seasar.framework.aop.interceptors.AbstractInterceptor {

    /** Serial version UID. (Default) */
    private static final long serialVersionUID = 1L;

    /** Log-instance. */
    private static final Log _log = LogFactory.getLog(LdCommonColumnSetupAbstractInterceptor.class);
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
        ...
        if (isEntityDefinedCommonColumn(firstArgument)) {
            final LdEntityDefinedCommonColumn entity = (LdEntityDefinedCommonColumn)firstArgument;
            ...
            for (final java.util.Iterator<?> ite = ls.iterator(); ite.hasNext(); ) {
                final LdEntityDefinedCommonColumn entity = (LdEntityDefinedCommonColumn)ite.next();
                setupEntity(entity);
            }
            return invocation.proceed();
        } else {
    ...
    protected boolean isEntityDefinedCommonColumn(Object obj) {
        ...
        if (obj instanceof LdEntityDefinedCommonColumn) {
            return true;
        } else {
            return false;
        }
    ...
    protected boolean isListSaveEntityDefinedCommonColumn(Object obj) {
        ...
        for (final java.util.Iterator<?> ite = ls.iterator(); ite.hasNext(); ) {
            ...
            if (!(currentObj instanceof LdEntityDefinedCommonColumn)) {
                return false;
            }
        }
        return true;
     ...
     */
    abstract protected void setupEntity(LdEntityDefinedCommonColumn entity);
