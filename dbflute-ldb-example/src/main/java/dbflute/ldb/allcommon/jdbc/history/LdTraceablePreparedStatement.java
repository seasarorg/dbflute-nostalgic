 ...
 */
public class LdTraceablePreparedStatement implements PreparedStatement {
    ...
    protected LdStatementHistory _statementHistory = new LdStatementHistory();

    protected LdStatementHistoryWitness _statementHistoryWitness;
     ...
     */
    public LdTraceablePreparedStatement(PreparedStatement preparedStatement, String preparedSql, LdStatementHistoryWitness statementHistoryWitness) {
    ...
    protected void registerPreparedParameter(int settingIndex, int jdbcType, Object parameterValue) {
        final LdPreparedParameterElement parameterElement = createPreparedParameterElement(settingIndex, jdbcType, parameterValue);
        _statementHistory.current().addParameterElement(parameterElement);
    }

    protected LdPreparedParameterElement createPreparedParameterElement(int settingIndex, int jdbcType, Object parameterValue) {
        final LdPreparedParameterElement element = new LdPreparedParameterElement();
    ...
    protected void setupSqlDisplayList(String realSql) {
        final java.util.List<LdPreparedExecutionBean> executionBeanList = _statementHistory.getPreparedExecutionBeanList();
        for (LdPreparedExecutionBean executionBean : executionBeanList) {
            final Object[] args = new Object[executionBean.size()];
            int index = 0;
            final java.util.List<LdPreparedParameterElement> parameterElementList = executionBean.getPreparedParameterElementList();
            for (LdPreparedParameterElement parameterElement : parameterElementList) {
