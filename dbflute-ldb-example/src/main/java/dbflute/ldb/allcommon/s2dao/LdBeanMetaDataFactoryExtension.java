...
import dbflute.ldb.allcommon.s2dao.internal.various.LdInternalIdentifierGeneratorFactory;
...
public class LdBeanMetaDataFactoryExtension extends BeanMetaDataFactoryImpl {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    /** The map of bean meta data for cache. */
    protected Map<Class<? extends LdEntity>, BeanMetaData> _metaMap = newConcurrentHashMap();
    ...
    protected BeanMetaDataImpl createBeanMetaDataImpl() {
        ...
        return new BeanMetaDataImpl() {
            ...
            protected IdentifierGenerator createInternalIdentifierGenerator(PropertyType propertyType, String idType) {
                return LdInternalIdentifierGeneratorFactory.createIdentifierGenerator(propertyType, getDbms(), idType);
            }
            @Override
    ...
    protected boolean isDBFluteEntity(Class beanClass) {
        return LdEntity.class.isAssignableFrom(beanClass);
    }
