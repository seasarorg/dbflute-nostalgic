 ...
 */
public abstract class LdInternalAbstractAutoStaticCommand extends LdInternalAbstractStaticCommand {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LdInternalAbstractAutoStaticCommand(DataSource dataSource
    ...
    public Object execute(Object[] args) { // NOT for Batch. Batch should override.
        LdInternalAbstractAutoHandler handler = createAutoHandler();
    ...
    protected LdEntityAlreadyUpdatedException createEntityAlreadyUpdatedException(Object bean, int rows) {
    ...
    protected abstract LdInternalAbstractAutoHandler createAutoHandler();
