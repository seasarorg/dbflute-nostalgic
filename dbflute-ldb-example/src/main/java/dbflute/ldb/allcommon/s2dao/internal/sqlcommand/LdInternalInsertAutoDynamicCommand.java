...
import dbflute.ldb.allcommon.s2dao.internal.sqlhandler.LdInternalInsertAutoHandler;

/**
 * @author DBFlute(AutoGenerator)
 */
public class LdInternalInsertAutoDynamicCommand implements SqlCommand, LdSqlExecution {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LdInternalInsertAutoDynamicCommand() {
    }
    ...
    public Object execute(Object[] args) {
        ...
        final LdInternalInsertAutoHandler handler = new LdInternalInsertAutoHandler(getDataSource(), getStatementFactory(), bmd, propertyTypes);
        handler.setSql(sql);
