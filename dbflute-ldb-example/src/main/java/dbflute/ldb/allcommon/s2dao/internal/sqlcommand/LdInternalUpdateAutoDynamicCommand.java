...
import dbflute.ldb.allcommon.s2dao.internal.sqlhandler.LdInternalUpdateAutoHandler;

/**
 * @author DBFlute(AutoGenerator)
 */
public class LdInternalUpdateAutoDynamicCommand extends LdInternalAbstractSqlCommand {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LdInternalUpdateAutoDynamicCommand(DataSource dataSource, StatementFactory statementFactory) {
    ...
    public Object execute(Object[] args) {
        ...
        LdInternalUpdateAutoHandler handler = createInternalUpdateAutoHandler(bmd, propertyTypes);
    ...
    protected LdInternalUpdateAutoHandler createInternalUpdateAutoHandler(BeanMetaData bmd, PropertyType[] propertyTypes) {
        LdInternalUpdateAutoHandler handler = new LdInternalUpdateAutoHandler(getDataSource(), getStatementFactory(), bmd, propertyTypes);
