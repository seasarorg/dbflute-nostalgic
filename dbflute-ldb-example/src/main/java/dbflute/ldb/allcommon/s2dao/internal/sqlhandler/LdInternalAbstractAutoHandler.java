 ...
 */
public abstract class LdInternalAbstractAutoHandler extends LdInternalBasicHandler {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LdInternalAbstractAutoHandler(DataSource dataSource,
    ...
    protected void setupUpdateBindVariables(Object bean) {
        ...
        for (int i = 0; i < propertyTypes.length; ++i) {
            ...
            if (pt.getPropertyName().equalsIgnoreCase(timestampPropertyName)) {
                ...
                int intValue = LdSimpleTypeUtil.toPrimitiveInt(value) + 1;
