...
import dbflute.ldb.allcommon.s2dao.internal.various.LdInternalProcedureParameterType;

/**
 * @author DBFlute(AutoGenerator)
 */
public class LdInternalProcedureHandler extends LdInternalBasicSelectHandler {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    private LdInternalProcedureMetaData procedureMetaData;
		
    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public LdInternalProcedureHandler(final DataSource dataSource, final String sql,
            final ResultSetHandler resultSetHandler, final StatementFactory statementFactory,
            final LdInternalProcedureMetaData procedureMetaData) {
    ...
    protected String getCompleteSql(final Object[] args) {// for Procedure Call
        ...
        int pos = 0;
        int pos2 = 0;
        for (LdInternalProcedureParameterType ppt : procedureMetaData.parameterTypes()) {
    ...
    protected ResultSetHandler createOutParameterResultSetHandler(LdInternalProcedureParameterType ppt, ResultSet resultSet) {
        return new InternalMapListResultSetHandler();
    }
    ...
    protected static abstract class InternalAbstractMapResultSetHandler implements ResultSetHandler {
        ...
        protected Map<String, Object> createRow(ResultSet rs, PropertyType[] propertyTypes) throws SQLException {
            Map<String, Object> row = LdStringKeyMap.createAsFlexible();
