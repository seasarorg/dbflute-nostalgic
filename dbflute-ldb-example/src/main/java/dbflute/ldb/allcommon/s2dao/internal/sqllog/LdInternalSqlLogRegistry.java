...
public class LdInternalSqlLogRegistry {
    ...
    //                                                                          ==========
    /** Log instance. */
    private static final org.apache.commons.logging.Log _log = org.apache.commons.logging.LogFactory.getLog(LdInternalSqlLogRegistry.class);
	...
	public static boolean setupSqlLogRegistry() {
	    ...
	    try {
		    ...
		    String msg = "LdInternalSqlLogRegistry.setupSqlLogRegistry() threw the exception:";
	...
	public static Object findContainerSqlLogRegistry() {
	    ...
	    try {
		    ...
		    String msg = "LdInternalSqlLogRegistry.findContainerSqlLogRegistry() threw the exception:";
			msg = msg + " sqlLogRegistryLocatorType=" + sqlLogRegistryLocatorType;
	...
	public static void closeRegistration() {
	    ...
	    try {
		    ...
		    String msg = "LdInternalSqlLogRegistry.closeRegistration() threw the exception:";
			msg = msg + " sqlLogRegistryLocatorType=" + sqlLogRegistryLocatorType;
			msg = msg + " NAME_setInstance=" + NAME_setInstance;
		    throw new IllegalStateException(msg, e);
		}
	...
	protected static Object createContainerSqlLogImpl(String rawSql, String completeSql, Object[] bindArgs, Class<?>[] bindArgTypes) {
	    try {
		    ...
		    String msg = "LdInternalSqlLogRegistry.createContainerSqlLogImpl() threw the exception:";
	...
	protected static void reflectSqlLogToContainerSqlLogRegistry(Object sqlLog, Object sqlLogRegistry) {
	    ...
	    try {
		    ...
		    String msg = "LdInternalSqlLogRegistry.reflectToContainerSqlLogRegistry() threw the exception:";
	...
	protected static Object findLastContainerSqlLog(Object sqlLogRegistry) {
	    ...
	    try {
		    ...
		    String msg = "LdInternalSqlLogRegistry.findLastContainerSqlLog() threw the exception:";
	...
	protected static String extractCompleteSqlFromContainerSqlLog(Object sqlLog) {
	    ...
	    try {
		    ...
		    String msg = "LdInternalSqlLogRegistry.extractCompleteSqlFromContainerSqlLog() threw the exception:";
