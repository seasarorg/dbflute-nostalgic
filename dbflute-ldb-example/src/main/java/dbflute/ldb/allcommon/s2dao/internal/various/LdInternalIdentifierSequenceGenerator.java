 ...
 */
public class LdInternalIdentifierSequenceGenerator extends LdInternalIdentifierAbstractGenerator {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LdInternalIdentifierSequenceGenerator(PropertyType propertyType, Dbms dbms) {
    ...
    public class IdContext {
        ...
        public synchronized long getNextValue(DataSource ds) {
            ...
            initialValue = LdSimpleTypeUtil.toPrimitiveLong(getNewInitialValue(ds));
            allocated = 1;
            return initialValue;
        }
    }
