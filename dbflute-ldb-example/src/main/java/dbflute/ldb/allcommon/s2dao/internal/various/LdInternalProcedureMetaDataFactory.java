 ...
 */
public class LdInternalProcedureMetaDataFactory {
    ...
    //                                                                                Main
    //                                                                                ====
    public LdInternalProcedureMetaData createProcedureMetaData(final String procedureName, final Class<?> pmbType) {
        final LdInternalProcedureMetaData metaData = new LdInternalProcedureMetaData(procedureName);
        if (pmbType == null) {
            return metaData;
        } else {
    ...
    protected void registerParameterType(LdInternalProcedureMetaData metaData, BeanDesc pmbDesc, Field[] fields) {
        for (Field field : fields) {
            if (!isInstanceField(field)) {
                continue;
            }
            final LdInternalProcedureParameterType ppt = getProcedureParameterType(pmbDesc, field);
            if (ppt == null) {
                continue;
            }
    ...
    protected LdInternalProcedureParameterType getProcedureParameterType(final BeanDesc dtoDesc, final Field field) {
        ...
        final LdInternalProcedureParameterType ppt = new LdInternalProcedureParameterType(field);
