...
/**
 * The entity of LENDING_COLLECTION that the type is TABLE. <br />
 * <pre>
 * [primary-key]
...
public abstract class LdBsLendingCollection implements LdEntityDefinedCommonColumn, java.io.Serializable {
    ...
    /** TABLE-Annotation for S2Dao. The value is LENDING_COLLECTION. */
    ...
    //                                                Column
    //                                                ------
    /** LIBRARY_ID: {PK : NotNull : SMALLINT : FK to LENDING} */
    protected Integer _libraryId;

    /** LB_USER_ID: {PK : NotNull : INTEGER : FK to LENDING} */
    protected Integer _lbUserId;

    /** LENDING_DATE: {PK : NotNull : TIMESTAMP : FK to LENDING} */
    ...
    /** RETURN_LIMIT_DATE: {NotNull : TIMESTAMP} */
    ...
    // /* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    //   Foreign Property = [lending]
    // * * * * * * * * */
    public static final int lending_RELNO = 1;
    public static final String lending_RELKEYS = "LIBRARY_ID:LIBRARY_ID, LB_USER_ID:LB_USER_ID, LENDING_DATE:LENDING_DATE";

    /** LENDING as 'lending'. */
    protected LdLending _parentLending;

    /**
     * LENDING as 'lending'. {without lazy-load}
     * @return The entity of foreign property 'lending'. (Nullable: If the foreign key does not have 'NotNull' constraint, please check null.)
     */
    ...
    /**
     * LENDING as 'lending'.
     * @param lending The entity of foreign property 'lending'. (Nullable)
     */
    ...
    // * * * * * * * * */
    public static final int libraryUser_RELNO = 2;
    ...
    /** The column annotation for S2Dao. {PK : NotNull : SMALLINT : FK to LENDING} */
    public static final String libraryId_COLUMN = "LIBRARY_ID";

    /**
     * LIBRARY_ID: {PK : NotNull : SMALLINT : FK to LENDING} <br />
    ...
    /** The column annotation for S2Dao. {PK : NotNull : INTEGER : FK to LENDING} */
    public static final String lbUserId_COLUMN = "LB_USER_ID";

    /**
     * LB_USER_ID: {PK : NotNull : INTEGER : FK to LENDING} <br />
    ...
    /** The column annotation for S2Dao. {PK : NotNull : TIMESTAMP : FK to LENDING} */
    public static final String lendingDate_COLUMN = "LENDING_DATE";

    /**
     * LENDING_DATE: {PK : NotNull : TIMESTAMP : FK to LENDING} <br />
    ...
    public static final String returnLimitDate_COLUMN = "RETURN_LIMIT_DATE";

    /**
     * RETURN_LIMIT_DATE: {NotNull : TIMESTAMP} <br />
     * @return The value of the column 'RETURN_LIMIT_DATE'. (Nullable)
     */
    ...
    /**
     * RETURN_LIMIT_DATE: {NotNull : TIMESTAMP} <br />
     * @param returnLimitDate The value of the column 'RETURN_LIMIT_DATE'. (Nullable)
     */
    public void setReturnLimitDate(java.sql.Timestamp returnLimitDate) {
        _modifiedProperties.addPropertyName("returnLimitDate");
