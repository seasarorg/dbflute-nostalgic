 ...
 */
public class LdBsAuthorCB extends LdAbstractConditionBean {
    ...
    public void acceptPrimaryKeyMap(Map<String, ? extends Object> primaryKeyMap) {
        assertPrimaryKeyMap(primaryKeyMap);
        {
            ...
            if (obj instanceof Integer) {
                query().setAuthorId_Equal((Integer)obj);
            } else {
                query().setAuthorId_Equal(new Integer((String)obj));
            }
        }
    ...
    public LdAuthorCQ getConditionQuery() {
        if (_conditionQuery == null) {
            _conditionQuery = new LdAuthorCQ(null, getSqlClause(), getSqlClause().getLocalTableAliasName(), 0);
        }
     ...
     * Set up 'union'.
     * <pre>
     * cb.query().union(new LdUnionQuery&lt;LdAuthorCB&gt;() {
     ...
     */
    public void union(LdUnionQuery<LdAuthorCB> unionQuery) {
        final LdAuthorCB cb = new LdAuthorCB(); cb.xsetupForUnion(); unionQuery.query(cb);
     ...
     * Set up 'union all'.
     * <pre>
     * cb.query().unionAll(new LdUnionQuery&lt;LdAuthorCB&gt;() {
     *     public void query(LdAuthorCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * @param unionQuery The query of 'union'. (NotNull)
     */
    public void unionAll(LdUnionQuery<LdAuthorCB> unionQuery) {
        final LdAuthorCB cb = new LdAuthorCB(); cb.xsetupForUnion(); unionQuery.query(cb);
    ...
    public Specification specify() {
        if (_specification == null) { _specification = new Specification(this, new SpQyCall<LdAuthorCQ>() {
            public boolean has() { return true; } public LdAuthorCQ qy() { return query(); } }, _forDerivedReferrer, _forScalarSelect, _forScalarSubQuery, getDBMetaProvider()); }
        return _specification;
    }

    public static class Specification extends AbstractSpecification<LdAuthorCQ> {
        protected SpQyCall<LdAuthorCQ> _myQyCall;
        public Specification(LdConditionBean baseCB, SpQyCall<LdAuthorCQ> qyCall
        ...
        public RAFunction<LdBookCB, LdAuthorCQ> derivedBookList() {
            return new RAFunction<LdBookCB, LdAuthorCQ>(_baseCB, _myQyCall.qy(), new RAQSetupper<LdBookCB, LdAuthorCQ>() {
                public void setup(String function, LdSubQuery<LdBookCB> subQuery, LdAuthorCQ cq, String aliasName) {
