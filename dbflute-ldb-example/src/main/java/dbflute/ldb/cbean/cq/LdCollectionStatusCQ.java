...
import dbflute.ldb.cbean.cq.bs.LdBsCollectionStatusCQ;
...
public class LdCollectionStatusCQ extends LdBsCollectionStatusCQ {
     ...
     */
    public LdCollectionStatusCQ(LdConditionQuery childQuery, LdSqlClause sqlClause, String aliasName, int nestLevel) {
