 ...
 */
public abstract class LdAbstractBsLendingCollectionCQ extends LdAbstractConditionQuery {
    ...
    /**
     * Equal(=). And NullIgnored, OnlyOnceRegistered. {PK : NotNull : SMALLINT : FK to LENDING}
    ...
    /**
     * Equal(=). And NullIgnored, OnlyOnceRegistered. {PK : NotNull : INTEGER : FK to LENDING}
    ...
    /**
     * Equal(=). And NullIgnored, OnlyOnceRegistered. {PK : NotNull : TIMESTAMP : FK to LENDING}
    ...
    /**
     * FromTo($fromDate &lt;= COLUMN_NAME &lt;= $toDate). And NullIgnored, OnlyOnceRegistered. {PK : NotNull : TIMESTAMP : FK to LENDING}
    ...
    /**
     * FromTo($fromDate &lt;= COLUMN_NAME &lt; $toDate + 1). And NullIgnored, OnlyOnceRegistered. {PK : NotNull : TIMESTAMP : FK to LENDING}
     * @param fromDate The from-date of lendingDate. (Nullable)
     * @param toDate The to-date of lendingDate. (Nullable)
     */
     ...
     * @param returnLimitDate The value of returnLimitDate as equal.
     */
    ...
    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered.
     * @param returnLimitDate The value of returnLimitDate as greaterThan.
     */
    ...
    /**
     * LessThan(&gt;). And NullIgnored, OnlyOnceRegistered.
     * @param returnLimitDate The value of returnLimitDate as lessThan.
     */
    ...
    /**
     * GreaterEqual(&gt;). And NullIgnored, OnlyOnceRegistered.
     * @param returnLimitDate The value of returnLimitDate as greaterEqual.
     */
    ...
    /**
     * LessEqual(&gt;). And NullIgnored, OnlyOnceRegistered.
     * @param returnLimitDate The value of returnLimitDate as lessEqual.
     */
     ...
     * @param fromDate The from-date of returnLimitDate. (Nullable)
     * @param toDate The to-date of returnLimitDate. (Nullable)
     * @param fromToOption The option of from-to. (NotNull)
     */
    public void setReturnLimitDate_FromTo(java.util.Date fromDate, java.util.Date toDate, dbflute.ldb.allcommon.cbean.coption.LdFromToOption fromToOption) {
        registerFromToQuery((fromDate != null ? new java.sql.Timestamp(fromDate.getTime()) : null), (toDate != null ? new java.sql.Timestamp(toDate.getTime()) : null), getCValueReturnLimitDate(), "RETURN_LIMIT_DATE", "ReturnLimitDate", "returnLimitDate", fromToOption);
    }
    ...
    public void setReturnLimitDate_DateFromTo(java.util.Date fromDate, java.util.Date toDate) {
        setReturnLimitDate_FromTo(fromDate, toDate, new dbflute.ldb.allcommon.cbean.coption.LdDateFromToOption());
    }

    protected void regReturnLimitDate(LdConditionKey key, Object value) {
        registerQuery(key, value, getCValueReturnLimitDate(), "RETURN_LIMIT_DATE", "ReturnLimitDate", "returnLimitDate");
    }
    protected void registerInlineReturnLimitDate(LdConditionKey key, Object value) {
        registerInlineQuery(key, value, getCValueReturnLimitDate(), "RETURN_LIMIT_DATE", "ReturnLimitDate", "returnLimitDate");
    }
    abstract protected LdConditionValue getCValueReturnLimitDate();
