 ...
 */
public abstract class LdAbstractBsLibraryTypeLookupCQ extends LdAbstractConditionQuery {
    ...
    public void inScopeLibraryList(LdSubQuery<LdLibraryCB> subQuery) {
        ...
        String subQueryPropertyName = keepLibraryTypeCode_InScopeSubQuery_LibraryList(cb.query()); // for saving query-value.
    ...
    public void notInScopeLibraryList(LdSubQuery<LdLibraryCB> subQuery) {
        assertObjectNotNull("subQuery<LdLibraryCB>", subQuery);
        LdLibraryCB cb = new LdLibraryCB(); cb.xsetupForInScopeSubQuery(); subQuery.query(cb);
        String subQueryPropertyName = keepLibraryTypeCode_NotInScopeSubQuery_LibraryList(cb.query()); // for saving query-value.
    ...
    /**
     * Set up 'exists' sub-query. {exists (select LIBRARY_TYPE_CODE from LIBRARY where ...)}
     * @param subQuery The sub-query of LibraryTypeCode_ExistsSubQuery_LibraryList for 'exists'. (NotNull)
     */
    public void existsLibraryList(LdSubQuery<LdLibraryCB> subQuery) {
        ...
        String subQueryPropertyName = keepLibraryTypeCode_ExistsSubQuery_LibraryList(cb.query()); // for saving query-value.
    ...
    /**
     * Set up 'not exists' sub-query. {not exists (select LIBRARY_TYPE_CODE from LIBRARY where ...)}
     * @param subQuery The sub-query of LibraryTypeCode_NotExistsSubQuery_LibraryList for 'not exists'. (NotNull)
     */
    public void notExistsLibraryList(LdSubQuery<LdLibraryCB> subQuery) {
        assertObjectNotNull("subQuery<LdLibraryCB>", subQuery);
        LdLibraryCB cb = new LdLibraryCB(); cb.xsetupForExistsSubQuery(); subQuery.query(cb);
        String subQueryPropertyName = keepLibraryTypeCode_NotExistsSubQuery_LibraryList(cb.query()); // for saving query-value.
    ...
    public void xsderiveLibraryList(String function, LdSubQuery<LdLibraryCB> subQuery, String aliasName) {
        assertObjectNotNull("subQuery<LdLibraryCB>", subQuery);
        LdLibraryCB cb = new LdLibraryCB(); cb.xsetupForDerivedReferrer(); subQuery.query(cb);
    ...
    protected QDRFunction<LdLibraryCB> xcreateQDRFunctionLibraryList() {
        return new QDRFunction<LdLibraryCB>(new QDRSetupper<LdLibraryCB>() {
            public void setup(String function, LdSubQuery<LdLibraryCB> subQuery, String operand, Object value) {
     ...
     * @param libraryTypeName The value of libraryTypeName as equal.
     */
    public void setLibraryTypeName_Equal(String libraryTypeName) {
        regLibraryTypeName(CK_EQ, fRES(libraryTypeName));
    }

    /**
     * Equal(=). As the empty-string. And NullOrEmptyIgnored, OnlyOnceRegistered.
     */
    public void setLibraryTypeName_Equal_EmptyString() {
        regLibraryTypeName(CK_EQ, "");
    }

    /**
     * NotEqual(!=). And NullOrEmptyIgnored, OnlyOnceRegistered.
     * @param libraryTypeName The value of libraryTypeName as notEqual.
     */
    public void setLibraryTypeName_NotEqual(String libraryTypeName) {
        regLibraryTypeName(CK_NE, fRES(libraryTypeName));
    }

    /**
     * PrefixSearch(like 'xxx%'). And NullOrEmptyIgnored, OnlyOnceRegistered.
     * @param libraryTypeName The value of libraryTypeName as prefixSearch.
     */
    public void setLibraryTypeName_PrefixSearch(String libraryTypeName) {
        regLibraryTypeName(CK_PS, fRES(libraryTypeName));
    }

    /**
     * InScope(in ('a', 'b')). And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered.
     * @param libraryTypeNameList The collection of libraryTypeName as inScope.
     */
    public void setLibraryTypeName_InScope(Collection<String> libraryTypeNameList) {
        regLibraryTypeName(CK_INS, cTL(libraryTypeNameList));
    }

    /**
     * NotInScope(not in ('a', 'b')). And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered.
     * @param libraryTypeNameList The collection of libraryTypeName as notInScope.
     */
    public void setLibraryTypeName_NotInScope(Collection<String> libraryTypeNameList) {
        regLibraryTypeName(CK_NINS, cTL(libraryTypeNameList));
    }

    /**
     * LikeSearch(like 'xxx%' escape ...). And NullOrEmptyIgnored, SeveralRegistered.
     * @param libraryTypeName The value of libraryTypeName as likeSearch.
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setLibraryTypeName_LikeSearch(String libraryTypeName, dbflute.ldb.allcommon.cbean.coption.LdLikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(libraryTypeName), getCValueLibraryTypeName(), "LIBRARY_TYPE_NAME", "LibraryTypeName", "libraryTypeName", likeSearchOption);
    }

    /**
     * NotLikeSearch(not like 'xxx%' escape ...). And NullOrEmptyIgnored, SeveralRegistered.
     * @param libraryTypeName The value of libraryTypeName as notLikeSearch.
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setLibraryTypeName_NotLikeSearch(String libraryTypeName, dbflute.ldb.allcommon.cbean.coption.LdLikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(libraryTypeName), getCValueLibraryTypeName(), "LIBRARY_TYPE_NAME", "LibraryTypeName", "libraryTypeName", likeSearchOption);
    }

    protected void regLibraryTypeName(LdConditionKey key, Object value) {
        registerQuery(key, value, getCValueLibraryTypeName(), "LIBRARY_TYPE_NAME", "LibraryTypeName", "libraryTypeName");
    }
    protected void registerInlineLibraryTypeName(LdConditionKey key, Object value) {
        registerInlineQuery(key, value, getCValueLibraryTypeName(), "LIBRARY_TYPE_NAME", "LibraryTypeName", "libraryTypeName");
    }
    abstract protected LdConditionValue getCValueLibraryTypeName();
    ...
    protected SSQFunction<LdLibraryTypeLookupCB> xcreateSSQFunction(final String operand) {
        return new SSQFunction<LdLibraryTypeLookupCB>(new SSQSetupper<LdLibraryTypeLookupCB>() {
            public void setup(String function, LdSubQuery<LdLibraryTypeLookupCB> subQuery) {
    ...
    protected void xscalarSubQuery(String function, LdSubQuery<LdLibraryTypeLookupCB> subQuery, String operand) {
        ...
        LdLibraryTypeLookupCB cb = new LdLibraryTypeLookupCB(); cb.xsetupForScalarSubQuery(); subQuery.query(cb);
