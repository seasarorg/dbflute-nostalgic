 ...
 */
public abstract class LdAbstractBsLibraryUserCQ extends LdAbstractConditionQuery {
    ...
    /**
     * Equal(=). And NullIgnored, OnlyOnceRegistered. {PK : NotNull : INTEGER : FK to LB_USER}
