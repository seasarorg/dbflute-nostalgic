...
/**
 * The condition-inline-query of GARBAGE.
...
public class LdGarbageCIQ extends LdAbstractBsGarbageCQ {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public LdGarbageCIQ(LdConditionQuery childQuery, LdSqlClause sqlClause, String aliasName, int nestLevel, LdBsGarbageCQ myCQ) {
