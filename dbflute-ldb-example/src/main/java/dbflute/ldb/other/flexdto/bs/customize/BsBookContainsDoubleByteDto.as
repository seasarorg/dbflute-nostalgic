...
/**
 * The flex DTO of BookContainsDoubleByte that the type is null.
 * <pre>
 * [primary-key]
 *     
 * 
 ...
 */
public class BsBookContainsDoubleByteDto {
    ...
    private var _bookNameWithSpace:String;
    ...
    public function get bookNameWithSpace():String {
        return _bookNameWithSpace;
    }

    public function set bookNameWithSpace(bookNameWithSpace:String):void {
