...
/**
 * The simple DTO of AUTHOR that the type is TABLE.
 * <pre>
 * [primary-key]
 *     AUTHOR_ID
 * 
...
public abstract class BsAuthorDto implements java.io.Serializable {
    ...
    //                                                                           Attribute
    //                                                                           =========
    /** The value of authorId. {PK : ID : NotNull : INTEGER} */
    protected Integer _authorId;

    /** The value of authorName. {NotNull : VARCHAR(80)} */
    protected String _authorName;

    /** The value of authorAge. {SMALLINT} */
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsAuthorDto)) { return false; }
        final BsAuthorDto otherEntity = (BsAuthorDto)other;
