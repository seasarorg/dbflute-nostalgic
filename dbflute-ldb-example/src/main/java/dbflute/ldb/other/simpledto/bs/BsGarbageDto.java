...
/**
 * The simple DTO of GARBAGE that the type is TABLE.
 * <pre>
 * [primary-key]
 *     
 * 
...
public abstract class BsGarbageDto implements java.io.Serializable {
    ...
    /** The value of RUser. {VARCHAR(100)} */
    protected String _rUser;

    /** The value of RTimestamp. {TIMESTAMP} */
    protected java.sql.Timestamp _rTimestamp;

    /** The value of UUser. {VARCHAR(100)} */
    protected String _uUser;

    /** The value of UTimestamp. {TIMESTAMP} */
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsGarbageDto)) { return false; }
        final BsGarbageDto otherEntity = (BsGarbageDto)other;
