...
/**
 * The simple DTO of PUBLISHER that the type is TABLE.
 * <pre>
 * [primary-key]
 *     PUBLISHER_ID
 * 
...
public abstract class BsPublisherDto implements java.io.Serializable {
    ...
    //                                                                           Attribute
    //                                                                           =========
    /** The value of publisherId. {PK : ID : NotNull : INTEGER} */
    protected Integer _publisherId;

    /** The value of publisherName. {NotNull : VARCHAR(80)} */
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsPublisherDto)) { return false; }
        final BsPublisherDto otherEntity = (BsPublisherDto)other;
    ...
    /**
     * Get the value of publisherName. <br />
     * {NotNull : VARCHAR(80)}
    ...
    /**
     * Set the value of publisherName. <br />
     * {NotNull : VARCHAR(80)}
     * @param publisherName The value of publisherName. (Nullable)
     */
