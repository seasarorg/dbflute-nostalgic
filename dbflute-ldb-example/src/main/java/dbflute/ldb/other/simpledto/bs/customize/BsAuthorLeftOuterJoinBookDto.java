...
/**
 * The simple DTO of AuthorLeftOuterJoinBook that the type is null.
 * <pre>
 * [primary-key]
 *     
 * 
...
public abstract class BsAuthorLeftOuterJoinBookDto implements java.io.Serializable {
    ...
    /** The value of authorName. {VARCHAR(80,0)} */
    protected String _authorName;

    /** The value of authorAge. {SMALLINT(5,0)} */
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsAuthorLeftOuterJoinBookDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsAuthorLeftOuterJoinBookDto)) { return false; }
        final BsAuthorLeftOuterJoinBookDto otherEntity = (BsAuthorLeftOuterJoinBookDto)other;
        ...
        if (!helpComparingValue(getAuthorAge(), otherEntity.getAuthorAge())) { return false; }
    ...
    public int hashCode() {
        ...
        if (this.getAuthorAge() != null) { result = result + this.getAuthorAge().hashCode(); }
    ...
    /**
     * Get the value of authorName. <br />
     * {VARCHAR(80,0)}
     * @return The value of authorName. (Nullable)
     */
    ...
    /**
     * Set the value of authorName. <br />
     * {VARCHAR(80,0)}
     * @param authorName The value of authorName. (Nullable)
     */
    ...
    /**
     * Get the value of authorAge. <br />
     * {SMALLINT(5,0)}
     * @return The value of authorAge. (Nullable)
     */
    ...
    /**
     * Set the value of authorAge. <br />
     * {SMALLINT(5,0)}
     * @param authorAge The value of authorAge. (Nullable)
     */
