...
/**
 * The simple DTO of BookSpecifiedOutsideSql that the type is null.
 * <pre>
 * [primary-key]
 *     BOOK_ID
 * 
...
public abstract class BsBookSpecifiedOutsideSqlDto implements java.io.Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsBookSpecifiedOutsideSqlDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsBookSpecifiedOutsideSqlDto)) { return false; }
        final BsBookSpecifiedOutsideSqlDto otherEntity = (BsBookSpecifiedOutsideSqlDto)other;
