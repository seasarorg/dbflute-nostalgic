...
/**
 * The paging-result-bean of LdOrderByClause.
 * 
 * @author DBFlute(AutoGenerator)
 */
public class LdOrderByClause implements java.io.Serializable {
    ...
    //                                                                             Attribute
    //                                                                             =========
    protected java.util.List<LdOrderByElement> _orderByList = new java.util.ArrayList<LdOrderByElement>();
    ...
    public void reverseAll() {
        for (final java.util.Iterator ite = _orderByList.iterator(); ite.hasNext(); ) {
            final LdOrderByElement element = (LdOrderByElement)ite.next();
            element.reverse();
        }
    }
     ...
     */
    public java.util.List<LdOrderByElement> getOrderByList() {
        return _orderByList;
    }
