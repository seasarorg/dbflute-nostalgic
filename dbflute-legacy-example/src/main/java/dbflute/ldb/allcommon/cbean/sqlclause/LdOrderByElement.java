...
/**
 * The paging-result-bean of LdOrderByElement.
 * 
 * <pre>
 *   For example, if you make order-by 'order BOOK.BOOK_ID asc', the way is as follows:
 *       /-----------------------------------------------------
 *       LdOrderByElement orderByElement = new LdOrderByElement();
 ...
 */
public class LdOrderByElement implements java.io.Serializable {
