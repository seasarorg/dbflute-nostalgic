...
public interface LdSqlClause {
     ...
     * @return this. (NotNull)
     */
    public LdSqlClause registerOuterJoin(String joinTableName, String aliasName, Map<String, String> joinOnMap);
     ...
     * @return this. (NotNull)
     */
    public LdSqlClause registerWhereClause(String columnFullName, LdConditionKey key, LdConditionValue value);
