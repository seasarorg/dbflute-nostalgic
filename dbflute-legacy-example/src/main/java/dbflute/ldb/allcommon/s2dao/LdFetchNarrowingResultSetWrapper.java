...
public class LdFetchNarrowingResultSetWrapper extends ResultSetWrapper {
    ...
    /** Log-instance. */
    private static final Log _log = LogFactory.getLog(LdFetchNarrowingResultSetWrapper.class);
    ...
    /** FetchNarrowing-bean. */
    private LdFetchNarrowingBean _cb;

    /** Fetch counter. */
    private long _counter;

    /** Is absolute used? */
    private boolean _isAbsoluteUsed = true;
     ...
     */
    public LdFetchNarrowingResultSetWrapper(ResultSet resultSet, LdFetchNarrowingBean cb) {
        super(resultSet);
     ...
     */
    protected LdFetchNarrowingBean getFetchNarrowingBean() {
        return _cb;
    }
