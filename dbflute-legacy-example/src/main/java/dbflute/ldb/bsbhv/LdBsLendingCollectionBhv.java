...
public abstract class LdBsLendingCollectionBhv extends dbflute.ldb.allcommon.bhv.LdAbstractBehaviorWritable {
     ...
     * Constructor.
     */
    public LdBsLendingCollectionBhv() {
    }
     ...
     * @return My dao.
     */
    public LdLendingCollectionDao getMyDao() {
        return _dao;
    }
     ...
     */
    public void setMyDao(LdLendingCollectionDao dao) {
     ...
     */
    public java.util.List<LdLendingCollection> delegateGetListAllTx() {
    ...
    //
    public LdLendingCollection delegateGetEntityTx(java.math.BigDecimal lendingId, java.math.BigDecimal collectionId) {
        return getMyDao().getEntity(lendingId, collectionId);
    }
     ...
     */
    public int delegateSelectCountIgnoreFetchScopeTx(LdLendingCollectionCB cb) {
     ...
     */
    public LdLendingCollection delegateSelectEntityTx(LdLendingCollectionCB cb) {
        assertConditionBeanNotNull(cb);
     ...
     */
    public java.util.List<LdLendingCollection> delegateSelectListTx(LdLendingCollectionCB cb) {
        assertConditionBeanNotNull(cb);
     ...
     */
    public int delegateInsertTx(LdLendingCollection entity) {
     ...
     */
    public int delegateUpdateTx(LdLendingCollection entity) {
     ...
     */
    public int delegateDeleteTx(LdLendingCollection entity) {
        assertEntityNotNullAndHasPrimaryKeyValue(entity);
     ...
     * @return Inserted count.
     */
    public int delegateInsertListTx(java.util.List<LdLendingCollection> entityList) {
     ...
     * @return Updated count.
     */
    public int delegateUpdateListTx(java.util.List<LdLendingCollection> entityList) {
        assertListNotNullAndEmpty(entityList);
     ...
     * @return Deleted count.
     */
    public int delegateDeleteListTx(java.util.List<LdLendingCollection> entityList) {
        assertListNotNullAndEmpty(entityList);
     ...
     */
    public LdListResultBean<LdLendingCollection> selectListTx(LdLendingCollectionCB cb) {
        assertConditionBeanNotNull(cb);
        return new ResultBeanBuilder<LdLendingCollection>(this).buildListResultBean(cb, delegateSelectListTx(cb));
    }
     ...
     */
    public LdPagingResultBean<LdLendingCollection> selectPageTx(final LdLendingCollectionCB cb) {
        assertConditionBeanNotNull(cb);
        final SelectPageCallback<LdLendingCollection> pageCallback = new SelectPageCallback<LdLendingCollection>() {
            ...
            public java.util.List<LdLendingCollection> selectList() {
                return delegateSelectListTx(cb);
            }
        };
        return new SelectPageInvoker<LdLendingCollection>(this).invokeSelectPage(pageCallback);
    }
     ...
     */
    public LdLendingCollection selectEntityWithDeletedCheckTx(LdLendingCollectionCB cb) {
        assertConditionBeanNotNull(cb);
        dbflute.ldb.exentity.LdLendingCollection currentEntity = delegateSelectEntityTx(cb);
     ...
     */
    public LdListResultBean selectListAfterCheckingCountIgnoreFetchScopeTx(LdLendingCollectionCB cb, int maxCount) {
        assertConditionBeanNotNull(cb);
    ...
    public LdLendingCollection selectForReadOnlyByPKValueWithDeletedCheckTx(java.math.BigDecimal lendingId, java.math.BigDecimal collectionId) {
        LdLendingCollection entity = new LdLendingCollection();
        entity.setLendingId(lendingId);entity.setCollectionId(collectionId);
     ...
     * @exception dbflute.ldb.allcommon.exception.LdRecordHasAlreadyBeenDeletedException
     */
    public LdLendingCollection selectForReadOnlyByPKMapStringWithDeletedCheckTx(String primaryKeyMapString) {
        ...
        final dbflute.ldb.exentity.LdLendingCollection currentEntity = delegateSelectEntityTx(cb);
        assertRecordHasNotBeenDeleted(currentEntity, primaryKeyMapString);
        return currentEntity;
    }

    public LdLendingCollection selectForUpdateByPKValueWithDeletedCheckTx(java.math.BigDecimal lendingId, java.math.BigDecimal collectionId) {
        LdLendingCollection entity = new LdLendingCollection();
        entity.setLendingId(lendingId);entity.setCollectionId(collectionId);
        return selectForReadOnlyByPKMapStringWithDeletedCheckTx(entity.extractPrimaryKeyMapString());
    }
     ...
     * @exception dbflute.ldb.allcommon.exception.LdRecordHasAlreadyBeenDeletedException
     */
    public LdLendingCollection selectForUpdateByPKMapStringWithDeletedCheckTx(String primaryKeyMapString) {
        assertStringNotNullAndNotTrimmedEmpty("primaryKeyMapString", primaryKeyMapString);
        final LdLendingCollectionCB cb = newMyConditionBean();
     ...
     * @return Updated count.
     */
    public int insertOrUpdateAfterSelectForUpdateTx(LdLendingCollection entity) {
        assertEntityNotNull(entity);
        final String mapString = entity.extractPrimaryKeyMapString();
        LdLendingCollection currentEntity = null;
        try {
     ...
     * @exception dbflute.ldb.allcommon.exception.LdRecordHasAlreadyBeenDeletedException
     */
    public int updateAfterSelectForUpdateTx(LdLendingCollection entity) {
        assertEntityNotNullAndHasPrimaryKeyValue(entity);
        final LdLendingCollection currentEntity = selectForUpdateByPKMapStringWithDeletedCheckTx(entity.extractPrimaryKeyMapString());
        mergeEntity(entity, currentEntity);
        return delegateUpdateTx(currentEntity);
    }
    ...
    protected void mergeEntity(LdEntity sourceEntity, LdEntity destinationEntity) {
        ...
        final LdLendingCollection sourceMyEntity = (LdLendingCollection)sourceEntity;
        final LdLendingCollection destinationMyEntity = (LdLendingCollection)destinationEntity;
        ...
        if (sourceMyEntity.isSetterInvokedReturnLimitDate()) {
            destinationMyEntity.setReturnLimitDate(sourceMyEntity.getReturnLimitDate());
        }
