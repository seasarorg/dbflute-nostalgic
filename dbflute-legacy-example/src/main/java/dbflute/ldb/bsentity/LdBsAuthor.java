 ...
 */
public abstract class LdBsAuthor implements LdEntityDefinedCommonColumn, java.io.Serializable {
    ...
    /** ID-Annotation */
    public static final String authorId_ID = "identity";
    ...
    public LdEntity acceptPrimaryKeyMap(java.util.Map<String, ? extends Object> primaryKeyMap) {
        ...
        {
            final Object obj = primaryKeyMap.get("AUTHOR_ID");
            if (obj == null) {
                setAuthorId(null);
            } else {
    ...
    public boolean equals(Object other) {
        if (!(other instanceof LdBsAuthor)) {
            return false;
        }
        if (other == null) {
            return false;
        ...
        final String otherMapString = ((LdBsAuthor)other).extractPrimaryKeyMapString();
    ...
    public int hashCode() {
        ...
        if (this.getAuthorId() != null) {
            result = result + this.getAuthorId().hashCode();
        }
