...
import dbflute.ldb.bsentity.dbmeta.LdBlackActionLookupDbm;
...
public abstract class LdBsBlackActionLookup implements LdEntityDefinedCommonColumn, java.io.Serializable {
    ...
    /** The value of blackActionName. */
    protected String _blackActionName;

    /** Has the setter of blackActionName been invoked? */
    protected boolean _isSetterInvokedBlackActionName;
    ...
    /**
     * Set the value of blackActionName.
     * 
     * @param v The value of blackActionName. (Nullable)
     */
    public void setBlackActionName(String v) {
        _isSetterInvokedBlackActionName = true;
        _blackActionName = v;
    }
     ...
     * @return Determination.
     */
    public boolean isSetterInvokedBlackActionName() {
        return _isSetterInvokedBlackActionName;
    }
    ...
    protected java.util.List<dbflute.ldb.exentity.LdBlackAction> _childrenBlackActionList;
     ...
     */
    public java.util.List<dbflute.ldb.exentity.LdBlackAction> getBlackActionList() {
     ...
     */
    public void setBlackActionList(java.util.List<dbflute.ldb.exentity.LdBlackAction> value) {
        _childrenBlackActionList = value;
    }
    ...
    public LdEntity acceptPrimaryKeyMap(java.util.Map<String, ? extends Object> primaryKeyMap) {
        ...
        if (!primaryKeyMap.containsKey("BLACK_ACTION_CODE")) {
            String msg = "The primaryKeyMap must have the value of BLACK_ACTION_CODE";
            throw new IllegalStateException(msg + ": primaryKeyMap --> " + primaryKeyMap);
        }
        {
            final Object obj = primaryKeyMap.get("BLACK_ACTION_CODE");
            if (obj == null) {
    ...
    public LdEntity acceptColumnValueMap(java.util.Map<String, ? extends Object> columnValueMap) {
        ...
        {
            final Object obj = columnValueMap.get("BLACK_ACTION_NAME");
            if (obj == null) {
                setBlackActionName(null);
            } else {
                if (obj instanceof String) {
                    setBlackActionName((String)obj);
                } else {
                    if (!(obj instanceof String)) {
                        String msg = "The value should be String or String: ";
                        msg = msg + "valueType=" + obj.getClass() + " value=" + obj;
    ...
    public String extractColumnValueMapString(String startBrace, String endBrace, String delimiter, String equal) {
        ...
        sb.append(delimiter).append("BLACK_ACTION_NAME").append(equal);
        sb.append((_blackActionName != null ? _blackActionName.toString() : ""));
    ...
    public boolean equals(Object other) {
        if (!(other instanceof LdBsBlackActionLookup)) {
            return false;
        }
        if (other == null) {
            return false;
        ...
        final String otherMapString = ((LdBsBlackActionLookup)other).extractPrimaryKeyMapString();
    ...
    public int hashCode() {
        ...
        if (this.getBlackActionCode() != null) {
            result = result + this.getBlackActionCode().hashCode();
        }
