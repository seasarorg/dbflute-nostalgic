...
import dbflute.ldb.bsentity.dbmeta.LdBlackListDbm;
...
public abstract class LdBsBlackList implements LdEntityDefinedCommonColumn, java.io.Serializable {
    ...
    /** The value of blackRank. */
    protected String _blackRank;

    /** Has the setter of blackRank been invoked? */
    protected boolean _isSetterInvokedBlackRank;
    ...
    /**
     * Set the value of blackRank.
     * 
     * @param v The value of blackRank. (Nullable)
     */
    public void setBlackRank(String v) {
        _isSetterInvokedBlackRank = true;
        _blackRank = v;
    }
     ...
     * @return Determination.
     */
    public boolean isSetterInvokedBlackRank() {
        return _isSetterInvokedBlackRank;
    }
    ...
    protected dbflute.ldb.exentity.LdLbUser _parentLbUser;
     ...
     */
    public dbflute.ldb.exentity.LdLbUser getLbUser() {
     ...
     */
    public void setLbUser(dbflute.ldb.exentity.LdLbUser v) {
        _parentLbUser = v;
    }
    ...
    public LdEntity acceptPrimaryKeyMap(java.util.Map<String, ? extends Object> primaryKeyMap) {
        ...
        if (!primaryKeyMap.containsKey("BLACK_LIST_ID")) {
            String msg = "The primaryKeyMap must have the value of BLACK_LIST_ID";
            throw new IllegalStateException(msg + ": primaryKeyMap --> " + primaryKeyMap);
        }
        {
            final Object obj = primaryKeyMap.get("BLACK_LIST_ID");
            if (obj == null) {
                setBlackListId(null);
            } else {
    ...
    public LdEntity acceptColumnValueMap(java.util.Map<String, ? extends Object> columnValueMap) {
        ...
        {
            final Object obj = columnValueMap.get("BLACK_RANK");
            if (obj == null) {
                setBlackRank(null);
            } else {
                if (obj instanceof String) {
                    setBlackRank((String)obj);
                } else {
                    if (!(obj instanceof String)) {
    ...
    public String extractColumnValueMapString(String startBrace, String endBrace, String delimiter, String equal) {
        ...
        sb.append(delimiter).append("BLACK_RANK").append(equal);
        sb.append((_blackRank != null ? _blackRank.toString() : ""));
    ...
    public boolean equals(Object other) {
        if (!(other instanceof LdBsBlackList)) {
            return false;
        }
        if (other == null) {
            return false;
        ...
        final String otherMapString = ((LdBsBlackList)other).extractPrimaryKeyMapString();
    ...
    public int hashCode() {
        ...
        if (this.getBlackListId() != null) {
            result = result + this.getBlackListId().hashCode();
        }
