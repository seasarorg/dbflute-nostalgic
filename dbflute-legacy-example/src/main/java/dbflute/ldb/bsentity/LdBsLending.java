...
import dbflute.ldb.bsentity.dbmeta.LdLendingDbm;
...
public abstract class LdBsLending implements LdEntityDefinedCommonColumn, java.io.Serializable {
    ...
    /** The value of lendingDate. */
    protected java.sql.Timestamp _lendingDate;

    /** Has the setter of lendingDate been invoked? */
    protected boolean _isSetterInvokedLendingDate;
    ...
    /**
     * Set the value of lendingDate.
     * 
     * @param v The value of lendingDate. (Nullable)
     */
    public void setLendingDate(java.sql.Timestamp v) {
        _isSetterInvokedLendingDate = true;
        _lendingDate = v;
    }
     ...
     * @return Determination.
     */
    public boolean isSetterInvokedLendingDate() {
        return _isSetterInvokedLendingDate;
    }
    ...
    /** RELNO of foreign table for s2dao. */
    public static final int lbUser_RELNO = 1;
    ...
    public LdEntity acceptColumnValueMap(java.util.Map<String, ? extends Object> columnValueMap) {
        ...
        {
            final Object obj = columnValueMap.get("LENDING_DATE");
            if (obj == null) {
                setLendingDate(null);
            } else {
                if (obj instanceof java.sql.Timestamp) {
                    setLendingDate((java.sql.Timestamp)obj);
                } else {
                    if (!(obj instanceof String)) {
                    ...
                    final String value = (String)obj;
                    try {
                        setLendingDate((java.sql.Timestamp)java.text.DateFormat.getDateTimeInstance().parse(value));
                    } catch (java.text.ParseException e) {
                        String msg = "setLendingDate((java.sql.Timestamp)java.text.DateFormat.getDateTimeInstance().parse(value))";
                        throw new RuntimeException(msg + " threw the exception: value=[" + value + "]", e);
                    } catch (RuntimeException e) {
                        String msg = "setLendingDate((java.sql.Timestamp)java.text.DateFormat.getDateTimeInstance().parse(value))";
                        throw new RuntimeException(msg + " threw the exception: value=[" + value + "]", e);
    ...
    public String extractColumnValueMapString(String startBrace, String endBrace, String delimiter, String equal) {
        ...
        sb.append(delimiter).append("LENDING_DATE").append(equal);
        sb.append((_lendingDate != null ? java.text.DateFormat.getDateTimeInstance().format(_lendingDate) : ""));
    ...
    public boolean equals(Object other) {
        if (!(other instanceof LdBsLending)) {
            return false;
        }
        if (other == null) {
            return false;
        ...
        final String otherMapString = ((LdBsLending)other).extractPrimaryKeyMapString();
