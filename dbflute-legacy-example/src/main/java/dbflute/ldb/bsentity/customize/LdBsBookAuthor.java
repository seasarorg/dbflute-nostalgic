...
import dbflute.ldb.bsentity.customize.dbmeta.LdBookAuthorDbm;
 ...
 */
public abstract class LdBsBookAuthor implements LdEntity, java.io.Serializable {
    ...
    /** The value of authorName. */
    protected String _authorName;

    /** Has the setter of authorName been invoked? */
    protected boolean _isSetterInvokedAuthorName;
    ...
    public LdDBMeta getDBMeta() {
        return LdBookAuthorDbm.getInstance();
    }
     ...
     * 
     * @param v The value of authorName. (Nullable)
     */
    public void setAuthorName(String v) {
        _isSetterInvokedAuthorName = true;
        _authorName = v;
    }
     ...
     * @return Determination.
     */
    public boolean isSetterInvokedAuthorName() {
        return _isSetterInvokedAuthorName;
    }
    ...
    public LdEntity acceptColumnValueMap(java.util.Map<String, ? extends Object> columnValueMap) {
        ...
        {
            final Object obj = columnValueMap.get("AUTHOR_NAME");
            if (obj == null) {
                setAuthorName(null);
            } else {
                if (obj instanceof String) {
    ...
    public String extractColumnValueMapString(String startBrace, String endBrace, String delimiter, String equal) {
        ...
        sb.append(delimiter).append("AUTHOR_NAME").append(equal);
        sb.append((_authorName != null ? _authorName.toString() : ""));
    ...
    public boolean equals(Object other) {
        if (!(other instanceof LdBsBookAuthor)) {
            return false;
        }
        if (other == null) {
            return false;
        ...
        final String otherMapString = ((LdBsBookAuthor)other).extractPrimaryKeyMapString();
