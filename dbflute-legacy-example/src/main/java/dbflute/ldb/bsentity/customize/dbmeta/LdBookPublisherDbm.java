...
/**
 * The dbmeta of BOOK_PUBLISHER. (Singleton)
 * 
 * <pre>
 * [primary-key]
 *     BOOK_ID
 ...
 */
public class LdBookPublisherDbm extends LdAbstractDBMeta {

    /** The type of entity. */
    public static final Class DAO_TYPE = LdBookPublisherDao.class;

    /** The type of entity. */
    public static final Class ENTITY_TYPE = LdBookPublisher.class;

    /** Singleton instance. */
    private static final LdBookPublisherDbm _instance = new LdBookPublisherDbm();

    /**
     * Constructor
     */
    private LdBookPublisherDbm() {
    }
     ...
     */
    public static LdBookPublisherDbm getInstance() {
        return _instance;
    }
    ...
    //                                                                       ===============
    /** Table db name. */
    public static final String TABLE_DB_NAME = "BOOK_PUBLISHER";

    /** Table cap-prop name. */
    public static final String TABLE_CAP_PROP_NAME = "BookPublisher";

    /** Table uncap-prop name. */
    public static final String TABLE_UNCAP_PROP_NAME = "bookPublisher";
    ...
    /** Db-name of PublisherName. */
    public static final String COLUMN_DB_NAME_OF_PublisherName = "PUBLISHER_NAME";
    ...
    /** Cap-prop-name of PublisherName. */
    public static final String COLUMN_CAP_PROP_NAME_OF_PublisherName = "PublisherName";
    ...
    /** Uncap-prop-name of PublisherName. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_PublisherName = "publisherName";
    ...
    static {
        ...
        map.put(COLUMN_DB_NAME_OF_PublisherName, COLUMN_CAP_PROP_NAME_OF_PublisherName);
    ...
    static {
        ...
        map.put(COLUMN_DB_NAME_OF_PublisherName, COLUMN_UNCAP_PROP_NAME_OF_PublisherName);
    ...
    static {
        ...
        map.put(COLUMN_CAP_PROP_NAME_OF_PublisherName, COLUMN_DB_NAME_OF_PublisherName);
    ...
    static {
        ...
        map.put(COLUMN_CAP_PROP_NAME_OF_PublisherName, COLUMN_UNCAP_PROP_NAME_OF_PublisherName);
    ...
    static {
        ...
        map.put(COLUMN_UNCAP_PROP_NAME_OF_PublisherName, COLUMN_DB_NAME_OF_PublisherName);
    ...
    static {
        ...
        map.put(COLUMN_UNCAP_PROP_NAME_OF_PublisherName, COLUMN_CAP_PROP_NAME_OF_PublisherName);
     ...
     */ 
    public LdBookPublisher newMyEntity() {
        return new LdBookPublisher();
    }
    ...
    /** The getter method of publisherName. */
    public static final java.lang.reflect.Method ENTITY_GETTER_METHOD_PublisherName;
    static {
        try {
            ENTITY_GETTER_METHOD_PublisherName = ENTITY_TYPE.getMethod("get" + COLUMN_CAP_PROP_NAME_OF_PublisherName, new Class[] {});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_PublisherName + " argsType=String";
            throw new IllegalStateException(msg, e);
        }
    }

    /** <summary>The setter method of publisherName. */
    public static final java.lang.reflect.Method ENTITY_SETTER_METHOD_PublisherName;
    static {
        try {
            ENTITY_SETTER_METHOD_PublisherName = ENTITY_TYPE.getMethod("set" + COLUMN_CAP_PROP_NAME_OF_PublisherName, new Class[] {String.class});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_PublisherName + " argsType=String";
            throw new IllegalStateException(msg, e);
        }
     ...
     * This method implements the method that is declared at super.
     * 
     * @return The getter method of publisherName. (NotNull)
     */
    public java.lang.reflect.Method getEntityGetterMethod_PublisherName() {
        return ENTITY_GETTER_METHOD_PublisherName;
    }

    /**
     * This method implements the method that is declared at super.
     * 
     * @return The setter method of publisherName. (NotNull)
     */
    public java.lang.reflect.Method getEntitySetterMethod_PublisherName() {
        return ENTITY_SETTER_METHOD_PublisherName;
    }
