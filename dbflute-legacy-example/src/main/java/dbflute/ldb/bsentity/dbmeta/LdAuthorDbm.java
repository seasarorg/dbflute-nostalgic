...
/**
 * The dbmeta of AUTHOR. (Singleton)
 * 
 * <pre>
 * [primary-key]
 *     AUTHOR_ID
...
public class LdAuthorDbm extends LdAbstractDBMeta {
    ...
    /** The type of entity. */
    public static final Class DAO_TYPE = LdAuthorDao.class;

    /** The type of entity. */
    public static final Class ENTITY_TYPE = LdAuthor.class;

    /** The type of condition-bean. */
    public static final Class CONDITION_BEAN_TYPE = LdAuthorCB.class;
    ...
    //                                                                       ===============
    /** Table db name. */
    public static final String TABLE_DB_NAME = "AUTHOR";

    /** Table cap-prop name. */
    public static final String TABLE_CAP_PROP_NAME = "Author";

    /** Table uncap-prop name. */
    public static final String TABLE_UNCAP_PROP_NAME = "author";
