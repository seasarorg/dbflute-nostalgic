...
/**
 * The dbmeta of BLACK_ACTION_LOOKUP. (Singleton)
 * 
 * <pre>
 * [primary-key]
 *     BLACK_ACTION_CODE
 * 
 * [column-property]
 *     BLACK_ACTION_CODE, BLACK_ACTION_NAME, R_TIME, U_TIME, R_STAFF, U_STAFF
 * 
 * [foreign-property]
 *     
 * 
...
public class LdBlackActionLookupDbm extends LdAbstractDBMeta {
    ...
    /** The type of entity. */
    public static final Class DAO_TYPE = LdBlackActionLookupDao.class;

    /** The type of entity. */
    public static final Class ENTITY_TYPE = LdBlackActionLookup.class;

    /** The type of condition-bean. */
    public static final Class CONDITION_BEAN_TYPE = LdBlackActionLookupCB.class;
    ...
    //                                                                       ===============
    /** Table db name. */
    public static final String TABLE_DB_NAME = "BLACK_ACTION_LOOKUP";

    /** Table cap-prop name. */
    public static final String TABLE_CAP_PROP_NAME = "BlackActionLookup";

    /** Table uncap-prop name. */
    public static final String TABLE_UNCAP_PROP_NAME = "blackActionLookup";


    /** Db-name of BlackActionCode. */
    public static final String COLUMN_DB_NAME_OF_BlackActionCode = "BLACK_ACTION_CODE";

    /** Db-name of BlackActionName. */
    public static final String COLUMN_DB_NAME_OF_BlackActionName = "BLACK_ACTION_NAME";
    ...
    /** Cap-prop-name of BlackActionName. */
    public static final String COLUMN_CAP_PROP_NAME_OF_BlackActionName = "BlackActionName";
    ...
    /** Uncap-prop-name of BlackActionName. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_BlackActionName = "blackActionName";
    ...
    static {
        ...
        map.put(COLUMN_DB_NAME_OF_BlackActionName, COLUMN_CAP_PROP_NAME_OF_BlackActionName);
    ...
    static {
        ...
        map.put(COLUMN_DB_NAME_OF_BlackActionName, COLUMN_UNCAP_PROP_NAME_OF_BlackActionName);
    ...
    static {
        ...
        map.put(COLUMN_CAP_PROP_NAME_OF_BlackActionName, COLUMN_DB_NAME_OF_BlackActionName);
    ...
    static {
        ...
        map.put(COLUMN_CAP_PROP_NAME_OF_BlackActionName, COLUMN_UNCAP_PROP_NAME_OF_BlackActionName);
    ...
    static {
        ...
        map.put(COLUMN_UNCAP_PROP_NAME_OF_BlackActionName, COLUMN_DB_NAME_OF_BlackActionName);
    ...
    static {
        ...
        map.put(COLUMN_UNCAP_PROP_NAME_OF_BlackActionName, COLUMN_CAP_PROP_NAME_OF_BlackActionName);
    ...
    /** The getter method of blackActionName. */
    public static final java.lang.reflect.Method ENTITY_GETTER_METHOD_BlackActionName;
    static {
        try {
            ENTITY_GETTER_METHOD_BlackActionName = ENTITY_TYPE.getMethod("get" + COLUMN_CAP_PROP_NAME_OF_BlackActionName, new Class[] {});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_BlackActionName + " argsType=String";
            throw new IllegalStateException(msg, e);
        }
    }

    /** <summary>The setter method of blackActionName. */
    public static final java.lang.reflect.Method ENTITY_SETTER_METHOD_BlackActionName;
    static {
        try {
            ENTITY_SETTER_METHOD_BlackActionName = ENTITY_TYPE.getMethod("set" + COLUMN_CAP_PROP_NAME_OF_BlackActionName, new Class[] {String.class});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_BlackActionName + " argsType=String";
            throw new IllegalStateException(msg, e);
        }
     ...
     * This method implements the method that is declared at super.
     * 
     * @return The getter method of blackActionName. (NotNull)
     */
    public java.lang.reflect.Method getEntityGetterMethod_BlackActionName() {
        return ENTITY_GETTER_METHOD_BlackActionName;
    }

    /**
     * This method implements the method that is declared at super.
     * 
     * @return The setter method of blackActionName. (NotNull)
     */
    public java.lang.reflect.Method getEntitySetterMethod_BlackActionName() {
        return ENTITY_SETTER_METHOD_BlackActionName;
    }
