...
/**
 * The dbmeta of COLLECTION. (Singleton)
 * 
 * <pre>
 * [primary-key]
 *     COLLECTION_ID
...
public class LdCollectionDbm extends LdAbstractDBMeta {
    ...
    /** The type of entity. */
    public static final Class DAO_TYPE = LdCollectionDao.class;

    /** The type of entity. */
    public static final Class ENTITY_TYPE = LdCollection.class;

    /** The type of condition-bean. */
    public static final Class CONDITION_BEAN_TYPE = LdCollectionCB.class;
    ...
    //                                                                       ===============
    /** Table db name. */
    public static final String TABLE_DB_NAME = "COLLECTION";

    /** Table cap-prop name. */
    public static final String TABLE_CAP_PROP_NAME = "Collection";

    /** Table uncap-prop name. */
    public static final String TABLE_UNCAP_PROP_NAME = "collection";
    ...
    /** Db-name of ArrivalDate. */
    public static final String COLUMN_DB_NAME_OF_ArrivalDate = "ARRIVAL_DATE";
    ...
    /** Cap-prop-name of ArrivalDate. */
    public static final String COLUMN_CAP_PROP_NAME_OF_ArrivalDate = "ArrivalDate";
    ...
    /** Cap-prop-name of book. */
    public static final String COLUMN_CAP_PROP_NAME_OF_Book = "Book";
    ...
    /** Uncap-prop-name of ArrivalDate. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_ArrivalDate = "arrivalDate";
    ...
    /** Uncap-prop-name of book. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_Book = "book";
    ...
    static {
        ...
        map.put(COLUMN_DB_NAME_OF_ArrivalDate, COLUMN_CAP_PROP_NAME_OF_ArrivalDate);
    ...
    static {
        ...
        map.put(COLUMN_DB_NAME_OF_ArrivalDate, COLUMN_UNCAP_PROP_NAME_OF_ArrivalDate);
    ...
    static {
        ...
        map.put(COLUMN_CAP_PROP_NAME_OF_ArrivalDate, COLUMN_DB_NAME_OF_ArrivalDate);
    ...
    static {
        ...
        map.put(COLUMN_CAP_PROP_NAME_OF_ArrivalDate, COLUMN_UNCAP_PROP_NAME_OF_ArrivalDate);
    ...
    static {
        ...
        map.put(COLUMN_UNCAP_PROP_NAME_OF_ArrivalDate, COLUMN_DB_NAME_OF_ArrivalDate);
    ...
    static {
        ...
        map.put(COLUMN_UNCAP_PROP_NAME_OF_ArrivalDate, COLUMN_CAP_PROP_NAME_OF_ArrivalDate);
    ...
    /** The getter method of arrivalDate. */
    public static final java.lang.reflect.Method ENTITY_GETTER_METHOD_ArrivalDate;
    static {
        try {
            ENTITY_GETTER_METHOD_ArrivalDate = ENTITY_TYPE.getMethod("get" + COLUMN_CAP_PROP_NAME_OF_ArrivalDate, new Class[] {});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_ArrivalDate + " argsType=java.sql.Timestamp";
            throw new IllegalStateException(msg, e);
        }
    }

    /** <summary>The setter method of arrivalDate. */
    public static final java.lang.reflect.Method ENTITY_SETTER_METHOD_ArrivalDate;
    static {
        try {
            ENTITY_SETTER_METHOD_ArrivalDate = ENTITY_TYPE.getMethod("set" + COLUMN_CAP_PROP_NAME_OF_ArrivalDate, new Class[] {java.sql.Timestamp.class});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_ArrivalDate + " argsType=java.sql.Timestamp";
            throw new IllegalStateException(msg, e);
        }
     ...
     * This method implements the method that is declared at super.
     * 
     * @return The getter method of arrivalDate. (NotNull)
     */
    public java.lang.reflect.Method getEntityGetterMethod_ArrivalDate() {
        return ENTITY_GETTER_METHOD_ArrivalDate;
    }

    /**
     * This method implements the method that is declared at super.
     * 
     * @return The setter method of arrivalDate. (NotNull)
     */
    public java.lang.reflect.Method getEntitySetterMethod_ArrivalDate() {
        return ENTITY_SETTER_METHOD_ArrivalDate;
    }
    ...
    /**
     * Get foreign dbmeta of Book.
     * 
     * @return Foreign DBMeta. (NotNull)
     */
    public LdBookDbm getForeignDBMeta_Book() {
