...
/**
 * The dbmeta of COLLECTION_STATUS_LOOKUP. (Singleton)
 * 
 * <pre>
 * [primary-key]
...
public class LdCollectionStatusLookupDbm extends LdAbstractDBMeta {
    ...
    /** The type of entity. */
    public static final Class DAO_TYPE = LdCollectionStatusLookupDao.class;

    /** The type of entity. */
    public static final Class ENTITY_TYPE = LdCollectionStatusLookup.class;

    /** The type of condition-bean. */
    public static final Class CONDITION_BEAN_TYPE = LdCollectionStatusLookupCB.class;
    ...
    //                                                                       ===============
    /** Table db name. */
    public static final String TABLE_DB_NAME = "COLLECTION_STATUS_LOOKUP";

    /** Table cap-prop name. */
    public static final String TABLE_CAP_PROP_NAME = "CollectionStatusLookup";

    /** Table uncap-prop name. */
    public static final String TABLE_UNCAP_PROP_NAME = "collectionStatusLookup";


    /** Db-name of CollectionStatusCode. */
    public static final String COLUMN_DB_NAME_OF_CollectionStatusCode = "COLLECTION_STATUS_CODE";

    /** Db-name of CollectionStatusName. */
    public static final String COLUMN_DB_NAME_OF_CollectionStatusName = "COLLECTION_STATUS_NAME";
    ...
    /** Cap-prop-name of CollectionStatusName. */
    public static final String COLUMN_CAP_PROP_NAME_OF_CollectionStatusName = "CollectionStatusName";
    ...
    /** Cap-prop-name of CollectionStatusList. */
    public static final String COLUMN_CAP_PROP_NAME_OF_CollectionStatusList = "CollectionStatusList";
    ...
    /** Uncap-prop-name of CollectionStatusName. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_CollectionStatusName = "collectionStatusName";
    ...
    /** Uncap-prop-name of collectionStatusList. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_CollectionStatusList = "collectionStatusList";
    ...
    static {
        ...
        map.put(COLUMN_DB_NAME_OF_CollectionStatusName, COLUMN_CAP_PROP_NAME_OF_CollectionStatusName);
    ...
    static {
        ...
        map.put(COLUMN_DB_NAME_OF_CollectionStatusName, COLUMN_UNCAP_PROP_NAME_OF_CollectionStatusName);
    ...
    static {
        ...
        map.put(COLUMN_CAP_PROP_NAME_OF_CollectionStatusName, COLUMN_DB_NAME_OF_CollectionStatusName);
    ...
    static {
        ...
        map.put(COLUMN_CAP_PROP_NAME_OF_CollectionStatusName, COLUMN_UNCAP_PROP_NAME_OF_CollectionStatusName);
    ...
    static {
        ...
        map.put(COLUMN_UNCAP_PROP_NAME_OF_CollectionStatusName, COLUMN_DB_NAME_OF_CollectionStatusName);
    ...
    static {
        ...
        map.put(COLUMN_UNCAP_PROP_NAME_OF_CollectionStatusName, COLUMN_CAP_PROP_NAME_OF_CollectionStatusName);
    ...
    /** The getter method of collectionStatusName. */
    public static final java.lang.reflect.Method ENTITY_GETTER_METHOD_CollectionStatusName;
    static {
        try {
            ENTITY_GETTER_METHOD_CollectionStatusName = ENTITY_TYPE.getMethod("get" + COLUMN_CAP_PROP_NAME_OF_CollectionStatusName, new Class[] {});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_CollectionStatusName + " argsType=String";
            throw new IllegalStateException(msg, e);
        }
    }

    /** <summary>The setter method of collectionStatusName. */
    public static final java.lang.reflect.Method ENTITY_SETTER_METHOD_CollectionStatusName;
    static {
        try {
            ENTITY_SETTER_METHOD_CollectionStatusName = ENTITY_TYPE.getMethod("set" + COLUMN_CAP_PROP_NAME_OF_CollectionStatusName, new Class[] {String.class});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_CollectionStatusName + " argsType=String";
            throw new IllegalStateException(msg, e);
        }
     ...
     * This method implements the method that is declared at super.
     * 
     * @return The getter method of collectionStatusName. (NotNull)
     */
    public java.lang.reflect.Method getEntityGetterMethod_CollectionStatusName() {
        return ENTITY_GETTER_METHOD_CollectionStatusName;
    }

    /**
     * This method implements the method that is declared at super.
     * 
     * @return The setter method of collectionStatusName. (NotNull)
     */
    public java.lang.reflect.Method getEntitySetterMethod_CollectionStatusName() {
        return ENTITY_SETTER_METHOD_CollectionStatusName;
    }
