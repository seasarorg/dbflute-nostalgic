...
/**
 * The dbmeta of LB_USER. (Singleton)
 * 
 * <pre>
 * [primary-key]
 *     LB_USER_ID
...
public class LdLbUserDbm extends LdAbstractDBMeta {
    ...
    /** The type of entity. */
    public static final Class DAO_TYPE = LdLbUserDao.class;

    /** The type of entity. */
    public static final Class ENTITY_TYPE = LdLbUser.class;

    /** The type of condition-bean. */
    public static final Class CONDITION_BEAN_TYPE = LdLbUserCB.class;
    ...
    //                                                                       ===============
    /** Table db name. */
    public static final String TABLE_DB_NAME = "LB_USER";

    /** Table cap-prop name. */
    public static final String TABLE_CAP_PROP_NAME = "LbUser";

    /** Table uncap-prop name. */
    public static final String TABLE_UNCAP_PROP_NAME = "lbUser";


    /** Db-name of LbUserId. */
    public static final String COLUMN_DB_NAME_OF_LbUserId = "LB_USER_ID";

    /** Db-name of LbUserName. */
    public static final String COLUMN_DB_NAME_OF_LbUserName = "LB_USER_NAME";

    /** Db-name of LibraryId. */
    public static final String COLUMN_DB_NAME_OF_LibraryId = "LIBRARY_ID";

    /** Db-name of UserPassword. */
    public static final String COLUMN_DB_NAME_OF_UserPassword = "USER_PASSWORD";
    ...
    /** Cap-prop-name of LbUserName. */
    public static final String COLUMN_CAP_PROP_NAME_OF_LbUserName = "LbUserName";

    /** Cap-prop-name of LibraryId. */
    public static final String COLUMN_CAP_PROP_NAME_OF_LibraryId = "LibraryId";

    /** Cap-prop-name of UserPassword. */
    public static final String COLUMN_CAP_PROP_NAME_OF_UserPassword = "UserPassword";
    ...
    /** Cap-prop-name of BlackListList. */
    public static final String COLUMN_CAP_PROP_NAME_OF_BlackListList = "BlackListList";

    /** Cap-prop-name of LendingList. */
    public static final String COLUMN_CAP_PROP_NAME_OF_LendingList = "LendingList";


    /** Uncap-prop-name of LbUserId. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_LbUserId = "lbUserId";

    /** Uncap-prop-name of LbUserName. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_LbUserName = "lbUserName";

    /** Uncap-prop-name of LibraryId. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_LibraryId = "libraryId";

    /** Uncap-prop-name of UserPassword. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_UserPassword = "userPassword";
    ...
    /** Uncap-prop-name of blackListList. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_BlackListList = "blackListList";

    /** Uncap-prop-name of lendingList. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_LendingList = "lendingList";
    ...
    static {
        ...
        map.put(COLUMN_DB_NAME_OF_LbUserName, COLUMN_CAP_PROP_NAME_OF_LbUserName);

        map.put(COLUMN_DB_NAME_OF_LibraryId, COLUMN_CAP_PROP_NAME_OF_LibraryId);

        map.put(COLUMN_DB_NAME_OF_UserPassword, COLUMN_CAP_PROP_NAME_OF_UserPassword);
    ...
    static {
        ...
        map.put(COLUMN_DB_NAME_OF_LbUserName, COLUMN_UNCAP_PROP_NAME_OF_LbUserName);

        map.put(COLUMN_DB_NAME_OF_LibraryId, COLUMN_UNCAP_PROP_NAME_OF_LibraryId);

        map.put(COLUMN_DB_NAME_OF_UserPassword, COLUMN_UNCAP_PROP_NAME_OF_UserPassword);
    ...
    static {
        ...
        map.put(COLUMN_CAP_PROP_NAME_OF_LbUserName, COLUMN_DB_NAME_OF_LbUserName);

        map.put(COLUMN_CAP_PROP_NAME_OF_LibraryId, COLUMN_DB_NAME_OF_LibraryId);

        map.put(COLUMN_CAP_PROP_NAME_OF_UserPassword, COLUMN_DB_NAME_OF_UserPassword);
    ...
    static {
        ...
        map.put(COLUMN_CAP_PROP_NAME_OF_LbUserName, COLUMN_UNCAP_PROP_NAME_OF_LbUserName);

        map.put(COLUMN_CAP_PROP_NAME_OF_LibraryId, COLUMN_UNCAP_PROP_NAME_OF_LibraryId);

        map.put(COLUMN_CAP_PROP_NAME_OF_UserPassword, COLUMN_UNCAP_PROP_NAME_OF_UserPassword);
    ...
    static {
        ...
        map.put(COLUMN_UNCAP_PROP_NAME_OF_LbUserName, COLUMN_DB_NAME_OF_LbUserName);

        map.put(COLUMN_UNCAP_PROP_NAME_OF_LibraryId, COLUMN_DB_NAME_OF_LibraryId);

        map.put(COLUMN_UNCAP_PROP_NAME_OF_UserPassword, COLUMN_DB_NAME_OF_UserPassword);
    ...
    static {
        ...
        map.put(COLUMN_UNCAP_PROP_NAME_OF_LbUserName, COLUMN_CAP_PROP_NAME_OF_LbUserName);

        map.put(COLUMN_UNCAP_PROP_NAME_OF_LibraryId, COLUMN_CAP_PROP_NAME_OF_LibraryId);

        map.put(COLUMN_UNCAP_PROP_NAME_OF_UserPassword, COLUMN_CAP_PROP_NAME_OF_UserPassword);
    ...
    /** The getter method of lbUserName. */
    public static final java.lang.reflect.Method ENTITY_GETTER_METHOD_LbUserName;
    static {
        try {
            ENTITY_GETTER_METHOD_LbUserName = ENTITY_TYPE.getMethod("get" + COLUMN_CAP_PROP_NAME_OF_LbUserName, new Class[] {});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_LbUserName + " argsType=String";
            throw new IllegalStateException(msg, e);
        }
    }

    /** <summary>The setter method of lbUserName. */
    public static final java.lang.reflect.Method ENTITY_SETTER_METHOD_LbUserName;
    static {
        try {
            ENTITY_SETTER_METHOD_LbUserName = ENTITY_TYPE.getMethod("set" + COLUMN_CAP_PROP_NAME_OF_LbUserName, new Class[] {String.class});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_LbUserName + " argsType=String";
            throw new IllegalStateException(msg, e);
        }
    ...
    /** The getter method of userPassword. */
    public static final java.lang.reflect.Method ENTITY_GETTER_METHOD_UserPassword;
    static {
        try {
            ENTITY_GETTER_METHOD_UserPassword = ENTITY_TYPE.getMethod("get" + COLUMN_CAP_PROP_NAME_OF_UserPassword, new Class[] {});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_UserPassword + " argsType=String";
            throw new IllegalStateException(msg, e);
        }
    }

    /** <summary>The setter method of userPassword. */
    public static final java.lang.reflect.Method ENTITY_SETTER_METHOD_UserPassword;
    static {
        try {
            ENTITY_SETTER_METHOD_UserPassword = ENTITY_TYPE.getMethod("set" + COLUMN_CAP_PROP_NAME_OF_UserPassword, new Class[] {String.class});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_UserPassword + " argsType=String";
            throw new IllegalStateException(msg, e);
        }
     ...
     * This method implements the method that is declared at super.
     * 
     * @return The getter method of lbUserName. (NotNull)
     */
    public java.lang.reflect.Method getEntityGetterMethod_LbUserName() {
        return ENTITY_GETTER_METHOD_LbUserName;
    }

    /**
     * This method implements the method that is declared at super.
     * 
     * @return The setter method of lbUserName. (NotNull)
     */
    public java.lang.reflect.Method getEntitySetterMethod_LbUserName() {
        return ENTITY_SETTER_METHOD_LbUserName;
    }
     ...
     * This method implements the method that is declared at super.
     * 
     * @return The getter method of userPassword. (NotNull)
     */
    public java.lang.reflect.Method getEntityGetterMethod_UserPassword() {
        return ENTITY_GETTER_METHOD_UserPassword;
    }

    /**
     * This method implements the method that is declared at super.
     * 
     * @return The setter method of userPassword. (NotNull)
     */
    public java.lang.reflect.Method getEntitySetterMethod_UserPassword() {
        return ENTITY_SETTER_METHOD_UserPassword;
    }
