...
/**
 * The dbmeta of LIBRARY. (Singleton)
 * 
 * <pre>
 * [primary-key]
 *     LIBRARY_ID
...
public class LdLibraryDbm extends LdAbstractDBMeta {
    ...
    /** The type of entity. */
    public static final Class DAO_TYPE = LdLibraryDao.class;

    /** The type of entity. */
    public static final Class ENTITY_TYPE = LdLibrary.class;

    /** The type of condition-bean. */
    public static final Class CONDITION_BEAN_TYPE = LdLibraryCB.class;
    ...
    //                                                                       ===============
    /** Table db name. */
    public static final String TABLE_DB_NAME = "LIBRARY";

    /** Table cap-prop name. */
    public static final String TABLE_CAP_PROP_NAME = "Library";

    /** Table uncap-prop name. */
    public static final String TABLE_UNCAP_PROP_NAME = "library";


    /** Db-name of LibraryId. */
    public static final String COLUMN_DB_NAME_OF_LibraryId = "LIBRARY_ID";

    /** Db-name of LibraryName. */
    public static final String COLUMN_DB_NAME_OF_LibraryName = "LIBRARY_NAME";
    ...
    /** Cap-prop-name of LibraryName. */
    public static final String COLUMN_CAP_PROP_NAME_OF_LibraryName = "LibraryName";
    ...
    /** Cap-prop-name of LbUserList. */
    public static final String COLUMN_CAP_PROP_NAME_OF_LbUserList = "LbUserList";

    /** Cap-prop-name of LendingList. */
    public static final String COLUMN_CAP_PROP_NAME_OF_LendingList = "LendingList";

    /** Cap-prop-name of NextLibraryByNextLibraryIdList. */
    public static final String COLUMN_CAP_PROP_NAME_OF_NextLibraryByNextLibraryIdList = "NextLibraryByNextLibraryIdList";

    /** Cap-prop-name of NextLibraryByLibraryIdList. */
    public static final String COLUMN_CAP_PROP_NAME_OF_NextLibraryByLibraryIdList = "NextLibraryByLibraryIdList";


    /** Uncap-prop-name of LibraryId. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_LibraryId = "libraryId";

    /** Uncap-prop-name of LibraryName. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_LibraryName = "libraryName";
    ...
    /** Uncap-prop-name of lbUserList. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_LbUserList = "lbUserList";

    /** Uncap-prop-name of lendingList. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_LendingList = "lendingList";

    /** Uncap-prop-name of nextLibraryByNextLibraryIdList. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_NextLibraryByNextLibraryIdList = "nextLibraryByNextLibraryIdList";

    /** Uncap-prop-name of nextLibraryByLibraryIdList. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_NextLibraryByLibraryIdList = "nextLibraryByLibraryIdList";
    ...
    static {
        ...
        map.put(COLUMN_DB_NAME_OF_LibraryName, COLUMN_CAP_PROP_NAME_OF_LibraryName);
    ...
    static {
        ...
        map.put(COLUMN_DB_NAME_OF_LibraryName, COLUMN_UNCAP_PROP_NAME_OF_LibraryName);
    ...
    static {
        ...
        map.put(COLUMN_CAP_PROP_NAME_OF_LibraryName, COLUMN_DB_NAME_OF_LibraryName);
    ...
    static {
        ...
        map.put(COLUMN_CAP_PROP_NAME_OF_LibraryName, COLUMN_UNCAP_PROP_NAME_OF_LibraryName);
    ...
    static {
        ...
        map.put(COLUMN_UNCAP_PROP_NAME_OF_LibraryName, COLUMN_DB_NAME_OF_LibraryName);
    ...
    static {
        ...
        map.put(COLUMN_UNCAP_PROP_NAME_OF_LibraryName, COLUMN_CAP_PROP_NAME_OF_LibraryName);
    ...
    /** The getter method of libraryName. */
    public static final java.lang.reflect.Method ENTITY_GETTER_METHOD_LibraryName;
    static {
        try {
            ENTITY_GETTER_METHOD_LibraryName = ENTITY_TYPE.getMethod("get" + COLUMN_CAP_PROP_NAME_OF_LibraryName, new Class[] {});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_LibraryName + " argsType=String";
            throw new IllegalStateException(msg, e);
        }
    }

    /** <summary>The setter method of libraryName. */
    public static final java.lang.reflect.Method ENTITY_SETTER_METHOD_LibraryName;
    static {
        try {
            ENTITY_SETTER_METHOD_LibraryName = ENTITY_TYPE.getMethod("set" + COLUMN_CAP_PROP_NAME_OF_LibraryName, new Class[] {String.class});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_LibraryName + " argsType=String";
            throw new IllegalStateException(msg, e);
        }
     ...
     * This method implements the method that is declared at super.
     * 
     * @return The getter method of libraryName. (NotNull)
     */
    public java.lang.reflect.Method getEntityGetterMethod_LibraryName() {
        return ENTITY_GETTER_METHOD_LibraryName;
    }

    /**
     * This method implements the method that is declared at super.
     * 
     * @return The setter method of libraryName. (NotNull)
     */
    public java.lang.reflect.Method getEntitySetterMethod_LibraryName() {
        return ENTITY_SETTER_METHOD_LibraryName;
    }
