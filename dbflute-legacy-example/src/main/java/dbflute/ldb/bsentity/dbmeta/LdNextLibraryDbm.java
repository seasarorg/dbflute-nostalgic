...
/**
 * The dbmeta of NEXT_LIBRARY. (Singleton)
 * 
 * <pre>
 * [primary-key]
...
public class LdNextLibraryDbm extends LdAbstractDBMeta {
    ...
    /** The type of entity. */
    public static final Class DAO_TYPE = LdNextLibraryDao.class;

    /** The type of entity. */
    public static final Class ENTITY_TYPE = LdNextLibrary.class;

    /** The type of condition-bean. */
    public static final Class CONDITION_BEAN_TYPE = LdNextLibraryCB.class;
    ...
    //                                                                       ===============
    /** Table db name. */
    public static final String TABLE_DB_NAME = "NEXT_LIBRARY";

    /** Table cap-prop name. */
    public static final String TABLE_CAP_PROP_NAME = "NextLibrary";

    /** Table uncap-prop name. */
    public static final String TABLE_UNCAP_PROP_NAME = "nextLibrary";


    /** Db-name of LibraryId. */
    public static final String COLUMN_DB_NAME_OF_LibraryId = "LIBRARY_ID";

    /** Db-name of NextLibraryId. */
    public static final String COLUMN_DB_NAME_OF_NextLibraryId = "NEXT_LIBRARY_ID";

    /** Db-name of DistanceKm. */
    public static final String COLUMN_DB_NAME_OF_DistanceKm = "DISTANCE_KM";
    ...
    /** Cap-prop-name of NextLibraryId. */
    public static final String COLUMN_CAP_PROP_NAME_OF_NextLibraryId = "NextLibraryId";

    /** Cap-prop-name of DistanceKm. */
    public static final String COLUMN_CAP_PROP_NAME_OF_DistanceKm = "DistanceKm";
    ...
    /** Cap-prop-name of libraryByNextLibraryId. */
    public static final String COLUMN_CAP_PROP_NAME_OF_LibraryByNextLibraryId = "LibraryByNextLibraryId";

    /** Cap-prop-name of libraryByLibraryId. */
    public static final String COLUMN_CAP_PROP_NAME_OF_LibraryByLibraryId = "LibraryByLibraryId";


    /** Uncap-prop-name of LibraryId. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_LibraryId = "libraryId";

    /** Uncap-prop-name of NextLibraryId. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_NextLibraryId = "nextLibraryId";

    /** Uncap-prop-name of DistanceKm. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_DistanceKm = "distanceKm";
    ...
    /** Uncap-prop-name of libraryByNextLibraryId. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_LibraryByNextLibraryId = "libraryByNextLibraryId";

    /** Uncap-prop-name of libraryByLibraryId. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_LibraryByLibraryId = "libraryByLibraryId";
    ...
    static {
        ...
        map.put(COLUMN_DB_NAME_OF_NextLibraryId, COLUMN_CAP_PROP_NAME_OF_NextLibraryId);

        map.put(COLUMN_DB_NAME_OF_DistanceKm, COLUMN_CAP_PROP_NAME_OF_DistanceKm);
    ...
    static {
        ...
        map.put(COLUMN_DB_NAME_OF_NextLibraryId, COLUMN_UNCAP_PROP_NAME_OF_NextLibraryId);

        map.put(COLUMN_DB_NAME_OF_DistanceKm, COLUMN_UNCAP_PROP_NAME_OF_DistanceKm);
    ...
    static {
        ...
        map.put(COLUMN_CAP_PROP_NAME_OF_NextLibraryId, COLUMN_DB_NAME_OF_NextLibraryId);

        map.put(COLUMN_CAP_PROP_NAME_OF_DistanceKm, COLUMN_DB_NAME_OF_DistanceKm);
    ...
    static {
        ...
        map.put(COLUMN_CAP_PROP_NAME_OF_NextLibraryId, COLUMN_UNCAP_PROP_NAME_OF_NextLibraryId);

        map.put(COLUMN_CAP_PROP_NAME_OF_DistanceKm, COLUMN_UNCAP_PROP_NAME_OF_DistanceKm);
    ...
    static {
        ...
        map.put(COLUMN_UNCAP_PROP_NAME_OF_NextLibraryId, COLUMN_DB_NAME_OF_NextLibraryId);

        map.put(COLUMN_UNCAP_PROP_NAME_OF_DistanceKm, COLUMN_DB_NAME_OF_DistanceKm);
    ...
    static {
        ...
        map.put(COLUMN_UNCAP_PROP_NAME_OF_NextLibraryId, COLUMN_CAP_PROP_NAME_OF_NextLibraryId);

        map.put(COLUMN_UNCAP_PROP_NAME_OF_DistanceKm, COLUMN_CAP_PROP_NAME_OF_DistanceKm);
     ...
     */ 
    public LdNextLibrary newMyEntity() {
        return new LdNextLibrary();
    }
     ...
     */ 
    public LdNextLibraryCB newMyConditionBean() {
    ...
    /** The getter method of nextLibraryId. */
    public static final java.lang.reflect.Method ENTITY_GETTER_METHOD_NextLibraryId;
    static {
        try {
            ENTITY_GETTER_METHOD_NextLibraryId = ENTITY_TYPE.getMethod("get" + COLUMN_CAP_PROP_NAME_OF_NextLibraryId, new Class[] {});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_NextLibraryId + " argsType=java.math.BigDecimal";
            throw new IllegalStateException(msg, e);
        }
    }

    /** <summary>The setter method of nextLibraryId. */
    public static final java.lang.reflect.Method ENTITY_SETTER_METHOD_NextLibraryId;
    static {
        try {
            ENTITY_SETTER_METHOD_NextLibraryId = ENTITY_TYPE.getMethod("set" + COLUMN_CAP_PROP_NAME_OF_NextLibraryId, new Class[] {java.math.BigDecimal.class});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_NextLibraryId + " argsType=java.math.BigDecimal";
            throw new IllegalStateException(msg, e);
        }
    ...
    /** The getter method of distanceKm. */
    public static final java.lang.reflect.Method ENTITY_GETTER_METHOD_DistanceKm;
    static {
        try {
            ENTITY_GETTER_METHOD_DistanceKm = ENTITY_TYPE.getMethod("get" + COLUMN_CAP_PROP_NAME_OF_DistanceKm, new Class[] {});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_DistanceKm + " argsType=java.math.BigDecimal";
            throw new IllegalStateException(msg, e);
        }
    }

    /** <summary>The setter method of distanceKm. */
    public static final java.lang.reflect.Method ENTITY_SETTER_METHOD_DistanceKm;
    static {
        try {
            ENTITY_SETTER_METHOD_DistanceKm = ENTITY_TYPE.getMethod("set" + COLUMN_CAP_PROP_NAME_OF_DistanceKm, new Class[] {java.math.BigDecimal.class});
        } catch (NoSuchMethodException e) {
            String msg = "The method doen not exist: methodName=" + "get" + COLUMN_CAP_PROP_NAME_OF_DistanceKm + " argsType=java.math.BigDecimal";
            throw new IllegalStateException(msg, e);
        }
     ...
     * This method implements the method that is declared at super.
     * 
     * @return The getter method of nextLibraryId. (NotNull)
     */
    public java.lang.reflect.Method getEntityGetterMethod_NextLibraryId() {
        return ENTITY_GETTER_METHOD_NextLibraryId;
    }

    /**
     * This method implements the method that is declared at super.
     * 
     * @return The setter method of nextLibraryId. (NotNull)
     */
    public java.lang.reflect.Method getEntitySetterMethod_NextLibraryId() {
        return ENTITY_SETTER_METHOD_NextLibraryId;
    }

    /**
     * This method implements the method that is declared at super.
     * 
     * @return The getter method of distanceKm. (NotNull)
     */
    public java.lang.reflect.Method getEntityGetterMethod_DistanceKm() {
        return ENTITY_GETTER_METHOD_DistanceKm;
    }

    /**
     * This method implements the method that is declared at super.
     * 
     * @return The setter method of distanceKm. (NotNull)
     */
    public java.lang.reflect.Method getEntitySetterMethod_DistanceKm() {
        return ENTITY_SETTER_METHOD_DistanceKm;
    }
    ...
    /**
     * Get foreign dbmeta of LibraryByNextLibraryId.
     * 
     * @return Foreign DBMeta. (NotNull)
     */
    public LdLibraryDbm getForeignDBMeta_LibraryByNextLibraryId() {
        return LdLibraryDbm.getInstance();
    }

    /**
     * Get foreign dbmeta of LibraryByLibraryId.
     * 
     * @return Foreign DBMeta. (NotNull)
     */
    public LdLibraryDbm getForeignDBMeta_LibraryByLibraryId() {
        return LdLibraryDbm.getInstance();
    }
