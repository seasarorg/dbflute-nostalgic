...
/**
 * The dbmeta of PUBLISHER. (Singleton)
 * 
 * <pre>
 * [primary-key]
 *     PUBLISHER_ID
...
public class LdPublisherDbm extends LdAbstractDBMeta {
    ...
    /** The type of entity. */
    public static final Class DAO_TYPE = LdPublisherDao.class;

    /** The type of entity. */
    public static final Class ENTITY_TYPE = LdPublisher.class;

    /** The type of condition-bean. */
    public static final Class CONDITION_BEAN_TYPE = LdPublisherCB.class;
    ...
    //                                                                       ===============
    /** Table db name. */
    public static final String TABLE_DB_NAME = "PUBLISHER";

    /** Table cap-prop name. */
    public static final String TABLE_CAP_PROP_NAME = "Publisher";

    /** Table uncap-prop name. */
    public static final String TABLE_UNCAP_PROP_NAME = "publisher";
    ...
    /** Cap-prop-name of BookList. */
    public static final String COLUMN_CAP_PROP_NAME_OF_BookList = "BookList";
    ...
    /** Uncap-prop-name of bookList. */
    public static final String COLUMN_UNCAP_PROP_NAME_OF_BookList = "bookList";
