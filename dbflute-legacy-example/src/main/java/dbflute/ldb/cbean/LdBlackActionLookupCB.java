 ...
 */
public class LdBlackActionLookupCB extends LdAbstractConditionBean {
    ...
    public LdBlackActionLookupCQ getConditionQuery() {
        if (_conditionQuery == null) {
            _conditionQuery = new LdBlackActionLookupCQ(null, getSqlClause(), getTableDbName(), 0);
        }
