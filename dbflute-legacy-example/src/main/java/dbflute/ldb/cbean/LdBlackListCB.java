 ...
 */
public class LdBlackListCB extends LdAbstractConditionBean {
    ...
    public LdConditionBean acceptPrimaryKeyMap(java.util.Map<String, ? extends Object> primaryKeyMap) {
        ...
        }
        {
            ...
            if (obj instanceof java.math.BigDecimal) {
                query().setBlackListId_Equal((java.math.BigDecimal)obj);
            } else {
                ...
                if (value != null) {
                    try {
                        query().setBlackListId_Equal(new java.math.BigDecimal(value));
                    } catch (RuntimeException e) {
                        String msg = "query().setBlackListId_Equal(new java.math.BigDecimal(value))";
    ...
    public LdBlackListCQ getConditionQuery() {
        if (_conditionQuery == null) {
            _conditionQuery = new LdBlackListCQ(null, getSqlClause(), getTableDbName(), 0);
        }
    ...
    /** Mark of select for lbUser */
    protected String _selectLbUser;
    /**
     * Get mark of select for lbUser.
     * 
     * @return Mark of select. (If null, this foreign entity is out of select.)
     */
    public String getLbUser_isSelect() {
        return _selectLbUser;
    }
    /**
     * Set up select for lbUser.
     * If you invoke this, this foreign entity is target of select.
     *
     * @return this.
     */
    public LdBlackListCB setupSelect_LbUser() {
