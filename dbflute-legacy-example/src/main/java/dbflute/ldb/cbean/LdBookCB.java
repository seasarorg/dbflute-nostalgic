 ...
 */
public class LdBookCB extends LdAbstractConditionBean {
    ...
    public LdConditionBean acceptPrimaryKeyMap(java.util.Map<String, ? extends Object> primaryKeyMap) {
        ...
        }
        {
            ...
            if (obj instanceof java.math.BigDecimal) {
                query().setBookId_Equal((java.math.BigDecimal)obj);
            } else {
                ...
                if (value != null) {
                    try {
                        query().setBookId_Equal(new java.math.BigDecimal(value));
                    } catch (RuntimeException e) {
                        String msg = "query().setBookId_Equal(new java.math.BigDecimal(value))";
    ...
    public LdBookCQ getConditionQuery() {
        if (_conditionQuery == null) {
            _conditionQuery = new LdBookCQ(null, getSqlClause(), getTableDbName(), 0);
        }
    ...
    /** Mark of select for author */
    protected String _selectAuthor;
    /**
     * Get mark of select for author.
     * 
     * @return Mark of select. (If null, this foreign entity is out of select.)
     */
    public String getAuthor_isSelect() {
        return _selectAuthor;
    }
    /**
     * Set up select for author.
     * If you invoke this, this foreign entity is target of select.
     *
     * @return this.
     */
    public LdBookCB setupSelect_Author() {
    ...
    /** Mark of select for publisher */
    protected String _selectPublisher;
    /**
     * Get mark of select for publisher.
     * 
     * @return Mark of select. (If null, this foreign entity is out of select.)
     */
    public String getPublisher_isSelect() {
        return _selectPublisher;
    }
    /**
     ...
     * @return this.
     */
    public LdBookCB setupSelect_Publisher() {
        // For setting outer join.
        query().queryPublisher();

        // Set dummy string that means this foreign entity is target of select.
        _selectPublisher = "dummy";
    ...
    /** Mark of select for genre */
    protected String _selectGenre;
    /**
     * Get mark of select for genre.
     * 
     * @return Mark of select. (If null, this foreign entity is out of select.)
     */
    public String getGenre_isSelect() {
        return _selectGenre;
    }
    /**
     * Set up select for genre.
     * If you invoke this, this foreign entity is target of select.
     *
     * @return this.
     */
    public LdBookCB setupSelect_Genre() {
        // For setting outer join.
        query().queryGenre();
