 ...
 */
public class LdCollectionStatusCB extends LdAbstractConditionBean {
    ...
    public LdCollectionStatusCQ getConditionQuery() {
        if (_conditionQuery == null) {
            _conditionQuery = new LdCollectionStatusCQ(null, getSqlClause(), getTableDbName(), 0);
        }
     ...
     * @return this.
     */
    public LdCollectionStatusCB setupSelect_Collection() {
    ...
    /** Mark of select for collectionStatusLookup */
    protected String _selectCollectionStatusLookup;
    /**
     * Get mark of select for collectionStatusLookup.
     * 
     * @return Mark of select. (If null, this foreign entity is out of select.)
     */
    public String getCollectionStatusLookup_isSelect() {
        return _selectCollectionStatusLookup;
    }
    /**
     * Set up select for collectionStatusLookup.
     * If you invoke this, this foreign entity is target of select.
     *
     * @return this.
     */
    public LdCollectionStatusCB setupSelect_CollectionStatusLookup() {
        // For setting outer join.
        query().queryCollectionStatusLookup();

        // Set dummy string that means this foreign entity is target of select.
        _selectCollectionStatusLookup = "dummy";
