 ...
 */
public class LdLendingCB extends LdAbstractConditionBean {
    ...
    public LdLendingCQ getConditionQuery() {
        if (_conditionQuery == null) {
            _conditionQuery = new LdLendingCQ(null, getSqlClause(), getTableDbName(), 0);
        }
     ...
     * @return this.
     */
    public LdLendingCB setupSelect_Library() {
     ...
     * @return this.
     */
    public LdLendingCB setupSelect_LbUser() {
        // For setting outer join.
        query().queryLbUser();
