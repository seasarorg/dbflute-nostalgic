 ...
 */
public class LdPublisherCB extends LdAbstractConditionBean {
    ...
    public LdConditionBean acceptPrimaryKeyMap(java.util.Map<String, ? extends Object> primaryKeyMap) {
        ...
        }
        {
            ...
            if (obj instanceof java.math.BigDecimal) {
                query().setPublisherId_Equal((java.math.BigDecimal)obj);
            } else {
                ...
                if (value != null) {
                    try {
                        query().setPublisherId_Equal(new java.math.BigDecimal(value));
                    } catch (RuntimeException e) {
                        String msg = "query().setPublisherId_Equal(new java.math.BigDecimal(value))";
    ...
    public LdPublisherCQ getConditionQuery() {
        if (_conditionQuery == null) {
            _conditionQuery = new LdPublisherCQ(null, getSqlClause(), getTableDbName(), 0);
        }
