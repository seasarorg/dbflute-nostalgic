...
#                                                                                 Overview
#                                                                                 ========
The example project for Lucy and DBFlute.
...
よって、Exampleプロジェクトで使っているその他のライブラリは全てLucy、もしくは、
テスト実行のため(H2やAtomikosなど)のライブラリとなります。
...
これはExample専用に作られた設定です。Exampleでは「Atomikos」を利用しています。
...
「src/test/java/com.example.dbflute.lucy.dbflute.howto.jp」配下
  o BehaviorBasicTest
...
機能をだけをサポートしてLucyに対応させた「AppLucyTestCase」を利用しています。
