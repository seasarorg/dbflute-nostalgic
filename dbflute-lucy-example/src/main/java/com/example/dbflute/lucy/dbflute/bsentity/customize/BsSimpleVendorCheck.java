...
public abstract class BsSimpleVendorCheck implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.lucy.dbflute.bsentity.customize.dbmeta.SimpleVendorCheckDbm.getInstance();
    }
     ...
     * @return The value of the column 'DECIMAL_DIGIT'. (NullAllowed even if selected: for no constraint)
     */
     ...
     * @param decimalDigit The value of the column 'DECIMAL_DIGIT'. (NullAllowed: null update allowed for no constraint)
     */
     ...
     * @return The value of the column 'INTEGER_NON_DIGIT'. (NullAllowed even if selected: for no constraint)
     */
     ...
     * @param integerNonDigit The value of the column 'INTEGER_NON_DIGIT'. (NullAllowed: null update allowed for no constraint)
     */
