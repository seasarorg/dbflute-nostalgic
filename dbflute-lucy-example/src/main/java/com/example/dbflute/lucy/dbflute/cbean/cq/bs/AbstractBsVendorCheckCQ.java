...
public abstract class AbstractBsVendorCheckCQ extends AbstractConditionQuery {
     ...
     * @param decimalDigit The value of decimalDigit as equal. (NullAllowed: if null, no condition)
     */
     ...
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br />
     * DECIMAL_DIGIT: {NotNull, DECIMAL(5, 3)}
     * @param decimalDigit The value of decimalDigit as greaterThan. (NullAllowed: if null, no condition)
     */
     ...
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br />
     * DECIMAL_DIGIT: {NotNull, DECIMAL(5, 3)}
     * @param decimalDigit The value of decimalDigit as lessThan. (NullAllowed: if null, no condition)
     */
     ...
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br />
     * DECIMAL_DIGIT: {NotNull, DECIMAL(5, 3)}
     * @param decimalDigit The value of decimalDigit as greaterEqual. (NullAllowed: if null, no condition)
     */
     ...
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br />
     * DECIMAL_DIGIT: {NotNull, DECIMAL(5, 3)}
     * @param decimalDigit The value of decimalDigit as lessEqual. (NullAllowed: if null, no condition)
     */
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * DECIMAL_DIGIT: {NotNull, DECIMAL(5, 3)}
     * @param minNumber The min number of decimalDigit. (NullAllowed: if null, no from-condition)
     * @param maxNumber The max number of decimalDigit. (NullAllowed: if null, no to-condition)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
     ...
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br />
     * DECIMAL_DIGIT: {NotNull, DECIMAL(5, 3)}
     * @param decimalDigitList The collection of decimalDigit as inScope. (NullAllowed: if null (or empty), no condition)
     */
     ...
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br />
     * DECIMAL_DIGIT: {NotNull, DECIMAL(5, 3)}
     * @param decimalDigitList The collection of decimalDigit as notInScope. (NullAllowed: if null (or empty), no condition)
     */
     ...
     * @param integerNonDigit The value of integerNonDigit as equal. (NullAllowed: if null, no condition)
     */
     ...
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br />
     * INTEGER_NON_DIGIT: {NotNull, DECIMAL(5)}
     * @param integerNonDigit The value of integerNonDigit as greaterThan. (NullAllowed: if null, no condition)
     */
     ...
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br />
     * INTEGER_NON_DIGIT: {NotNull, DECIMAL(5)}
     * @param integerNonDigit The value of integerNonDigit as lessThan. (NullAllowed: if null, no condition)
     */
     ...
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br />
     * INTEGER_NON_DIGIT: {NotNull, DECIMAL(5)}
     * @param integerNonDigit The value of integerNonDigit as greaterEqual. (NullAllowed: if null, no condition)
     */
     ...
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br />
     * INTEGER_NON_DIGIT: {NotNull, DECIMAL(5)}
     * @param integerNonDigit The value of integerNonDigit as lessEqual. (NullAllowed: if null, no condition)
     */
     ...
     * And NullIgnored, OnlyOnceRegistered. <br />
     * INTEGER_NON_DIGIT: {NotNull, DECIMAL(5)}
     * @param minNumber The min number of integerNonDigit. (NullAllowed: if null, no from-condition)
     * @param maxNumber The max number of integerNonDigit. (NullAllowed: if null, no to-condition)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
     ...
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br />
     * INTEGER_NON_DIGIT: {NotNull, DECIMAL(5)}
     * @param integerNonDigitList The collection of integerNonDigit as inScope. (NullAllowed: if null (or empty), no condition)
     */
     ...
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br />
     * INTEGER_NON_DIGIT: {NotNull, DECIMAL(5)}
     * @param integerNonDigitList The collection of integerNonDigit as notInScope. (NullAllowed: if null (or empty), no condition)
     */
