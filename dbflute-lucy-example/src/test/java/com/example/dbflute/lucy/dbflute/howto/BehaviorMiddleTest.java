...
import com.example.dbflute.lucy.dbflute.exbhv.pmbean.OptionMemberPmb;
import com.example.dbflute.lucy.dbflute.exbhv.pmbean.PurchaseMaxPriceMemberPmb;
...
import com.example.dbflute.lucy.dbflute.exentity.customize.OptionMember;
import com.example.dbflute.lucy.dbflute.exentity.customize.PurchaseMaxPriceMember;
...
public class BehaviorMiddleTest extends ContainerTestCase {
    ...
    public void test_outsideSql_selectList_selectOptionMember_LikeSearchOption_Tx() {
        ...
        pmb.setMemberName("ストイコ100%ビッチ_その", new LikeSearchOption().likePrefix());
