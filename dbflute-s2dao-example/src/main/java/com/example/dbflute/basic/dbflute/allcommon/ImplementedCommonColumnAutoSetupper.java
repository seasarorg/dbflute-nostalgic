...
public class ImplementedCommonColumnAutoSetupper implements CommonColumnAutoSetupper {
    ...
    public void handleCommonColumnOfInsertIfNeeds(Entity targetEntity) {
        ...
        final java.sql.Timestamp registerDatetime = com.example.dbflute.basic.dbflute.allcommon.AccessContext.getAccessTimestampOnThread();
        entity.setRegisterDatetime(registerDatetime);

        final String registerUser = com.example.dbflute.basic.dbflute.allcommon.AccessContext.getAccessUserOnThread();
        entity.setRegisterUser(registerUser);

        final String registerProcess = com.example.dbflute.basic.dbflute.allcommon.AccessContext.getAccessProcessOnThread();
    ...
    public void handleCommonColumnOfUpdateIfNeeds(Entity targetEntity) {
        ...
        final java.sql.Timestamp updateDatetime = com.example.dbflute.basic.dbflute.allcommon.AccessContext.getAccessTimestampOnThread();
        entity.setUpdateDatetime(updateDatetime);

        final String updateUser = com.example.dbflute.basic.dbflute.allcommon.AccessContext.getAccessUserOnThread();
        entity.setUpdateUser(updateUser);

        final String updateProcess = com.example.dbflute.basic.dbflute.allcommon.AccessContext.getAccessProcessOnThread();
        entity.setUpdateProcess(updateProcess);
    }
}
