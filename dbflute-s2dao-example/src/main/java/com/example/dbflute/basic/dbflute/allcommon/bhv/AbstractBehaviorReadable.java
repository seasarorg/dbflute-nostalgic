...
import com.example.dbflute.basic.dbflute.allcommon.BehaviorSelector;
import com.example.dbflute.basic.dbflute.allcommon.Entity;
import com.example.dbflute.basic.dbflute.allcommon.bhv.batch.TokenFileOutputOption;
import com.example.dbflute.basic.dbflute.allcommon.bhv.batch.TokenFileOutputResult;
...
import com.example.dbflute.basic.dbflute.allcommon.bhv.core.command.AbstractBehaviorCommand;
import com.example.dbflute.basic.dbflute.allcommon.bhv.core.command.SelectCountCBCommand;
import com.example.dbflute.basic.dbflute.allcommon.bhv.core.command.SelectListCBCommand;
import com.example.dbflute.basic.dbflute.allcommon.bhv.core.command.SelectNextValCommand;
import com.example.dbflute.basic.dbflute.allcommon.bhv.core.command.SelectScalarCBCommand;
import com.example.dbflute.basic.dbflute.allcommon.bhv.setup.ValueLabelSetupper;
import com.example.dbflute.basic.dbflute.allcommon.bhv.setup.ValueLabelBox;
import com.example.dbflute.basic.dbflute.allcommon.bhv.load.LoadReferrerOption;
...
import com.example.dbflute.basic.dbflute.allcommon.cbean.PagingHandler;
import com.example.dbflute.basic.dbflute.allcommon.cbean.PagingInvoker;
import com.example.dbflute.basic.dbflute.allcommon.cbean.PagingBean;
import com.example.dbflute.basic.dbflute.allcommon.cbean.PagingResultBean;
...
import com.example.dbflute.basic.dbflute.allcommon.cbean.outsidesql.executor.OutsideSqlBasicExecutor;
import com.example.dbflute.basic.dbflute.allcommon.dbmeta.info.ColumnInfo;
import com.example.dbflute.basic.dbflute.allcommon.helper.token.file.FileMakingOption;
import com.example.dbflute.basic.dbflute.allcommon.helper.token.file.FileMakingHeaderInfo;
import com.example.dbflute.basic.dbflute.allcommon.helper.token.file.FileMakingSimpleFacade;
import com.example.dbflute.basic.dbflute.allcommon.helper.token.file.impl.FileMakingSimpleFacadeImpl;
...
public abstract class AbstractBehaviorReadable implements BehaviorReadable {
    ...
    protected <ENTITY extends Entity, CB extends ConditionBean>
        ...
        } catch (com.example.dbflute.basic.dbflute.allcommon.exception.DangerousResultSizeException e) {
    ...
    public ListResultBean<Entity> readList(ConditionBean cb) {
        assertCBNotNull(cb);
        return new com.example.dbflute.basic.dbflute.allcommon.cbean.ResultBeanBuilder<Entity>(getTableDbName()).buildListResultBean(cb, callReadList(cb));
    }
     ...
     * @exception com.example.dbflute.basic.dbflute.allcommon.exception.EntityAlreadyDeletedException
     */
     ...
     * @param searchKey4Log Search-key for Logging. (NotNull)
     * @exception com.example.dbflute.basic.dbflute.allcommon.exception.EntityAlreadyDeletedException
     * @exception com.example.dbflute.basic.dbflute.allcommon.exception.EntityDuplicatedException
     */
