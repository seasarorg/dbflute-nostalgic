package com.example.dbflute.basic.dbflute.allcommon.cbean.outsidesql;
...
import com.example.dbflute.basic.dbflute.allcommon.jdbc.CursorHandler;
import com.example.dbflute.basic.dbflute.allcommon.jdbc.StatementConfig;
import com.example.dbflute.basic.dbflute.allcommon.util.SimpleResourceUtil;
...
public class OutsideSqlContext {
    ...
    public static void throwOutsideSqlNotFoundException(String path) {
        ...
        msg = msg + "* * * * * * * * * */" + getLineSeparator();
        throw new com.example.dbflute.basic.dbflute.allcommon.exception.OutsideSqlNotFoundException(msg);
    }
     ...
     * @exception com.example.dbflute.basic.dbflute.allcommon.exception.OutsideSqlNotFoundException When the SQL is not found.
     */
