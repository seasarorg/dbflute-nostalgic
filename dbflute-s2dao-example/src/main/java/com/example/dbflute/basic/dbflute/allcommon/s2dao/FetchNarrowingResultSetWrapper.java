...
import com.example.dbflute.basic.dbflute.allcommon.cbean.FetchNarrowingBean;
import com.example.dbflute.basic.dbflute.allcommon.s2dao.internal.sqlhandler.InternalBasicHandler.SQLExceptionHandler;
...
public class FetchNarrowingResultSetWrapper extends ResultSetWrapper {
    ...
    protected void checkSafetyResult(boolean hasNext) {
        if (hasNext && getSafetyMaxResultSize() > 0 && _requestCounter > (getSafetyMaxResultSize() + 1)) {
            ...
            throw new com.example.dbflute.basic.dbflute.allcommon.exception.DangerousResultSizeException(msg, getSafetyMaxResultSize());
        }
    }
