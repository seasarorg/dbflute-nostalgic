...
public class InternalIdentifierGeneratorFactory {
    ...
    static {
        addIdentifierGeneratorClass("assigned", InternalIdentifierAssignedGenerator.class);
        addIdentifierGeneratorClass("identity", InternalIdentifierIdentityGenerator.class);
        addIdentifierGeneratorClass("sequence", InternalIdentifierSequenceGenerator.class);
    }
