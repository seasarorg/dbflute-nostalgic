 ...
 */
public class InternalIdentifierSequenceGenerator extends InternalIdentifierAbstractGenerator {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public InternalIdentifierSequenceGenerator(PropertyType propertyType, Dbms dbms) {
    ...
    public class IdContext {
        ...
        public synchronized long getNextValue(DataSource ds) {
            ...
            initialValue = SimpleTypeUtil.toPrimitiveLong(getNewInitialValue(ds));
            allocated = 1;
            return initialValue;
        }
    }
