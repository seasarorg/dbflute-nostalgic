...
public class BsMapLikeSearchPmb  {
    ...
    protected com.example.dbflute.basic.dbflute.allcommon.cbean.coption.LikeSearchOption _conditionMapInternalLikeSearchOption;
     ...
     */
    public void setConditionMap(java.util.Map<String, Object> conditionMap, com.example.dbflute.basic.dbflute.allcommon.cbean.coption.LikeSearchOption conditionMapOption) {
        _conditionMap = conditionMap;
     ...
     */
    public com.example.dbflute.basic.dbflute.allcommon.cbean.coption.LikeSearchOption getConditionMapInternalLikeSearchOption() {
