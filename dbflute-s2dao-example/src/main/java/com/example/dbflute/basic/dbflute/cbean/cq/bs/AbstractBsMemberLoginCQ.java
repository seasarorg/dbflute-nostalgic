...
public abstract class AbstractBsMemberLoginCQ extends AbstractConditionQuery {
     ...
     */
    public void setLoginDatetime_FromTo(java.util.Date fromDate, java.util.Date toDate, com.example.dbflute.basic.dbflute.allcommon.cbean.coption.FromToOption fromToOption) {
    ...
    public void setLoginDatetime_DateFromTo(java.util.Date fromDate, java.util.Date toDate) {
        setLoginDatetime_FromTo(fromDate, toDate, new com.example.dbflute.basic.dbflute.allcommon.cbean.coption.DateFromToOption());
    }
     ...
     */
    public void setLoginMemberStatusCode_LikeSearch(String loginMemberStatusCode, com.example.dbflute.basic.dbflute.allcommon.cbean.coption.LikeSearchOption likeSearchOption) {
     ...
     */
    public void setLoginMemberStatusCode_NotLikeSearch(String loginMemberStatusCode, com.example.dbflute.basic.dbflute.allcommon.cbean.coption.LikeSearchOption likeSearchOption) {
