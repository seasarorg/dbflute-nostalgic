...
public abstract class AbstractBsProductStatusCQ extends AbstractConditionQuery {
     ...
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setProductStatusName_LikeSearch(String productStatusName, com.example.dbflute.basic.dbflute.allcommon.cbean.coption.LikeSearchOption likeSearchOption) {
     ...
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setProductStatusName_NotLikeSearch(String productStatusName, com.example.dbflute.basic.dbflute.allcommon.cbean.coption.LikeSearchOption likeSearchOption) {
