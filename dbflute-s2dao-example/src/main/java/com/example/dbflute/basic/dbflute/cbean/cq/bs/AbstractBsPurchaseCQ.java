...
public abstract class AbstractBsPurchaseCQ extends AbstractConditionQuery {
     ...
     */
    public void setPurchaseDatetime_FromTo(java.util.Date fromDate, java.util.Date toDate, com.example.dbflute.basic.dbflute.allcommon.cbean.coption.FromToOption fromToOption) {
    ...
    public void setPurchaseDatetime_DateFromTo(java.util.Date fromDate, java.util.Date toDate) {
        setPurchaseDatetime_FromTo(fromDate, toDate, new com.example.dbflute.basic.dbflute.allcommon.cbean.coption.DateFromToOption());
    }
