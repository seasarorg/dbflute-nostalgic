...
public abstract class AbstractBsSummaryProductCQ extends AbstractConditionQuery {
     ...
     */
    public void setLatestPurchaseDatetime_FromTo(java.util.Date fromDate, java.util.Date toDate, com.example.dbflute.basic.dbflute.allcommon.cbean.coption.FromToOption fromToOption) {
    ...
    public void setLatestPurchaseDatetime_DateFromTo(java.util.Date fromDate, java.util.Date toDate) {
        setLatestPurchaseDatetime_FromTo(fromDate, toDate, new com.example.dbflute.basic.dbflute.allcommon.cbean.coption.DateFromToOption());
    }
