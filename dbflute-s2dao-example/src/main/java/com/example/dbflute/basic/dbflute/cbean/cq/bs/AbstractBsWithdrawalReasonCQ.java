...
public abstract class AbstractBsWithdrawalReasonCQ extends AbstractConditionQuery {
     ...
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setWithdrawalReasonText_LikeSearch(String withdrawalReasonText, com.example.dbflute.basic.dbflute.allcommon.cbean.coption.LikeSearchOption likeSearchOption) {
     ...
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setWithdrawalReasonText_NotLikeSearch(String withdrawalReasonText, com.example.dbflute.basic.dbflute.allcommon.cbean.coption.LikeSearchOption likeSearchOption) {
