...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("MEMBER", "com.example.dbflute.slim3.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("MEMBER_ADDRESS", "com.example.dbflute.slim3.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("MEMBER_LOGIN", "com.example.dbflute.slim3.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("MEMBER_SECURITY", "com.example.dbflute.slim3.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("MEMBER_STATUS", "com.example.dbflute.slim3.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("MEMBER_WITHDRAWAL", "com.example.dbflute.slim3.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("PRODUCT", "com.example.dbflute.slim3.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("PRODUCT_STATUS", "com.example.dbflute.slim3.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("PURCHASE", "com.example.dbflute.slim3.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("VENDOR_CHECK", "com.example.dbflute.slim3.dbflute.bsentity.dbmeta.VendorCheckDbm");
        tmpMap.put("WITHDRAWAL_REASON", "com.example.dbflute.slim3.dbflute.bsentity.dbmeta.WithdrawalReasonDbm");
        tmpMap.put("SUMMARY_PRODUCT", "com.example.dbflute.slim3.dbflute.bsentity.dbmeta.SummaryProductDbm");
