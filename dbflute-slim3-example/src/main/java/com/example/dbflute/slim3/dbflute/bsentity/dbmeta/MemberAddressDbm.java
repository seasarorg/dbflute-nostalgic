...
public class MemberAddressDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberAddressId = cci("MEMBER_ADDRESS_ID", "MEMBER_ADDRESS_ID", null, null, true, "memberAddressId", Integer.class, true, false, "INTEGER", 10, 0, null, false, null, null, null, null, null);
    ...
    public ForeignInfo foreignMember() {
        ...
        return cfi("FK_MEMBER_ADDRESS_MEMBER", "member", this, MemberDbm.getInstance(), map, 0, false, false, false, false, null, false, "memberAddressList");
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.slim3.dbflute.exentity.MemberAddress"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.slim3.dbflute.cbean.MemberAddressCB"; }
    public String getDaoTypeName() { return "${glPackageExtendedDao}.MemberAddressDao"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.slim3.dbflute.exbhv.MemberAddressBhv"; }
