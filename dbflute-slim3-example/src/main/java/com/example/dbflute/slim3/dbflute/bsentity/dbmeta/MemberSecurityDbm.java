...
public class MemberSecurityDbm extends AbstractDBMeta {
    ...
    public ForeignInfo foreignMember() {
        ...
        return cfi("FK_MEMBER_SECURITY_MEMBER", "member", this, MemberDbm.getInstance(), map, 0, true, false, false, false, null, false, "memberSecurityAsOne");
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.slim3.dbflute.exentity.MemberSecurity"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.slim3.dbflute.cbean.MemberSecurityCB"; }
    public String getDaoTypeName() { return "${glPackageExtendedDao}.MemberSecurityDao"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.slim3.dbflute.exbhv.MemberSecurityBhv"; }
