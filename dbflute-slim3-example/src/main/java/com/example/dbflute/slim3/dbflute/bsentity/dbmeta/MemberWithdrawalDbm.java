...
public class MemberWithdrawalDbm extends AbstractDBMeta {
    ...
    public ForeignInfo foreignMember() {
        ...
        return cfi("FK_MEMBER_WITHDRAWAL_MEMBER", "member", this, MemberDbm.getInstance(), map, 0, true, false, false, false, null, false, "memberWithdrawalAsOne");
    }
    public ForeignInfo foreignWithdrawalReason() {
        ...
        return cfi("FK_MEMBER_WITHDRAWAL_WITHDRAWAL_REASON", "withdrawalReason", this, WithdrawalReasonDbm.getInstance(), map, 1, false, false, false, false, null, false, "memberWithdrawalList");
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.slim3.dbflute.exentity.MemberWithdrawal"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.slim3.dbflute.cbean.MemberWithdrawalCB"; }
    public String getDaoTypeName() { return "${glPackageExtendedDao}.MemberWithdrawalDao"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.slim3.dbflute.exbhv.MemberWithdrawalBhv"; }
