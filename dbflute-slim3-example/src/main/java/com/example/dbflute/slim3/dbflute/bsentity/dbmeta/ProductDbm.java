...
public class ProductDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, null, true, "productId", Integer.class, true, true, "INTEGER", 10, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_6E9AB2CD_5910_4735_8876_A28D1FF01237", false, null, null, null, "purchaseList", null);
    ...
    public ForeignInfo foreignProductStatus() {
        ...
        return cfi("FK_PRODUCT_PRODUCT_STATUS", "productStatus", this, ProductStatusDbm.getInstance(), map, 0, false, false, false, false, null, false, "productList");
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.slim3.dbflute.exentity.Product"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.slim3.dbflute.cbean.ProductCB"; }
    public String getDaoTypeName() { return "${glPackageExtendedDao}.ProductDao"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.slim3.dbflute.exbhv.ProductBhv"; }
