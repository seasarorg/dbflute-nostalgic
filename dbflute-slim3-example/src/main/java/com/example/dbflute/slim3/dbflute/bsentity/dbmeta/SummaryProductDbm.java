...
public class SummaryProductDbm extends AbstractDBMeta {
    ...
    public ForeignInfo foreignProductStatus() {
        ...
        return cfi("FK_SUMMARY_PRODUCT_PRODUCT_STATUS", "productStatus", this, ProductStatusDbm.getInstance(), map, 0, false, false, false, true, null, false, "summaryProductList");
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.slim3.dbflute.exentity.SummaryProduct"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.slim3.dbflute.cbean.SummaryProductCB"; }
    public String getDaoTypeName() { return "${glPackageExtendedDao}.SummaryProductDao"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.slim3.dbflute.exbhv.SummaryProductBhv"; }
