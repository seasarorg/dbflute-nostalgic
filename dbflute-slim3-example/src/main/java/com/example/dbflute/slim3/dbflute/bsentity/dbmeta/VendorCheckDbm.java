...
public class VendorCheckDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.slim3.dbflute.exentity.VendorCheck"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.slim3.dbflute.cbean.VendorCheckCB"; }
    public String getDaoTypeName() { return "${glPackageExtendedDao}.VendorCheckDao"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.slim3.dbflute.exbhv.VendorCheckBhv"; }
