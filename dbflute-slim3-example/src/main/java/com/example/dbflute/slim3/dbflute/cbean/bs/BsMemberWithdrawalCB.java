package com.example.dbflute.slim3.dbflute.cbean.bs;
...
import com.example.dbflute.slim3.dbflute.allcommon.ImplementedInvokerAssistant;
import com.example.dbflute.slim3.dbflute.allcommon.ImplementedSqlClauseCreator;
import com.example.dbflute.slim3.dbflute.cbean.*;
import com.example.dbflute.slim3.dbflute.cbean.cq.*;
import com.example.dbflute.slim3.dbflute.cbean.nss.*;
...
public class BsMemberWithdrawalCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberWithdrawalCQ> {
        ...
        public HpSDRFunction<MemberWithdrawalCB, MemberWithdrawalCQ> myselfDerived() {
            assertDerived("withdrawalReason"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
