...
public class BsVendorCheckCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<VendorCheckCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnDecimalDigit() { return doColumn("DECIMAL_DIGIT"); }
        /**
         * INTEGER_NON_DIGIT: {NotNull, DECIMAL(5)}
         * @return The information object of specified column. (NotNull)
         */
        public HpSpecifiedColumn columnIntegerNonDigit() { return doColumn("INTEGER_NON_DIGIT"); }
        /**
