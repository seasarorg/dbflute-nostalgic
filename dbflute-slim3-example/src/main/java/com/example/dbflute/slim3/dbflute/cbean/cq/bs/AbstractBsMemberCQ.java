...
public abstract class AbstractBsMemberCQ extends AbstractConditionQuery {
     ...
     * MEMBER_ADDRESS by your MEMBER_ID, named 'memberAddressAsOne'.
     * <pre>
     ...
     * MEMBER_LOGIN by your MEMBER_ID, named 'memberLoginAsOne'.
     * <pre>
     ...
     * PURCHASE by your MEMBER_ID, named 'purchaseAsOne'.
     * <pre>
     ...
     * FORMALIZED_DATETIME: {IX, TIMESTAMP(23, 10)}
     * @param formalizedDatetimeList The collection of formalizedDatetime as inScope.
     */
     ...
     * FORMALIZED_DATETIME: {IX, TIMESTAMP(23, 10)}
     * @param formalizedDatetimeList The collection of formalizedDatetime as notInScope.
     */
     ...
     * InScope {in ('1965-03-03', '1966-09-15')}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br />
     * BIRTHDATE: {DATE(8)}
     * @param birthdateList The collection of birthdate as inScope.
     */
     ...
     * NotInScope {not in ('1965-03-03', '1966-09-15')}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br />
     * BIRTHDATE: {DATE(8)}
     * @param birthdateList The collection of birthdate as notInScope.
     */
