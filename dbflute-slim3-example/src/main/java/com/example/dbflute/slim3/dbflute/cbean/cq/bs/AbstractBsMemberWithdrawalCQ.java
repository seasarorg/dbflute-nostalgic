...
public abstract class AbstractBsMemberWithdrawalCQ extends AbstractConditionQuery {
     ...
     * WITHDRAWAL_DATETIME: {NotNull, TIMESTAMP(23, 10)}
     * @param withdrawalDatetimeList The collection of withdrawalDatetime as inScope.
     */
     ...
     * WITHDRAWAL_DATETIME: {NotNull, TIMESTAMP(23, 10)}
     * @param withdrawalDatetimeList The collection of withdrawalDatetime as notInScope.
     */
