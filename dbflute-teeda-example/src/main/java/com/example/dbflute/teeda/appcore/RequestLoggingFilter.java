...
public class RequestLoggingFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        this.errorLogging = getBooleanParameter(filterConfig, "errorLogging", true);
    }
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain)
        ...
        try {
            ...
            logError("RuntimeException occurred at " + gerServletPath(request), e);
            throw e;
        } catch (ServletException e) {
            logError("ServletException occurred at " + gerServletPath(request), e.getRootCause());
            throw e;
        } catch (IOException e) {
    ...
    protected void before(HttpServletRequest request, HttpServletResponse response) {
        ...
        sb.append("Request class=" + request.getClass().getName()).append(", instance=").append(
    ...
    protected void after(HttpServletRequest request, HttpServletResponse response, Long before, Long after) {
        ...
        sb.append(LF);
        buildSessionAttributes(sb, request);
        sb.append("* * * * * * * * * * {END}: ").append(gerServletPath(request));
