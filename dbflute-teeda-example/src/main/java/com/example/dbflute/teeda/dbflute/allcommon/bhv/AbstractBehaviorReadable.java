...
import com.example.dbflute.teeda.dbflute.allcommon.bhv.batch.TokenFileOutputOption;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.batch.TokenFileOutputResult;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.BehaviorCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.BehaviorCommandInvoker;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.AbstractBehaviorCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.SelectCountCBCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.SelectListCBCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.SelectNextValCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.SelectScalarCBCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.setup.ValueLabelSetupper;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.setup.ValueLabelBox;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.load.LoadReferrerOption;
...
import com.example.dbflute.teeda.dbflute.allcommon.cbean.ScalarQuery;
import com.example.dbflute.teeda.dbflute.allcommon.cbean.sqlclause.SqlClause;
import com.example.dbflute.teeda.dbflute.allcommon.cbean.outsidesql.executor.OutsideSqlBasicExecutor;
import com.example.dbflute.teeda.dbflute.allcommon.dbmeta.info.ColumnInfo;
import com.example.dbflute.teeda.dbflute.allcommon.helper.token.file.FileMakingOption;
import com.example.dbflute.teeda.dbflute.allcommon.helper.token.file.FileMakingHeaderInfo;
import com.example.dbflute.teeda.dbflute.allcommon.helper.token.file.FileMakingSimpleFacade;
import com.example.dbflute.teeda.dbflute.allcommon.helper.token.file.impl.FileMakingSimpleFacadeImpl;
...
public abstract class AbstractBehaviorReadable implements BehaviorReadable {
    ...
    protected <ENTITY extends Entity, CB extends ConditionBean>
        ...
        } catch (com.example.dbflute.teeda.dbflute.allcommon.exception.DangerousResultSizeException e) {
    ...
    public ListResultBean<Entity> readList(ConditionBean cb) {
        assertCBNotNull(cb);
        return new com.example.dbflute.teeda.dbflute.allcommon.cbean.ResultBeanBuilder<Entity>(getTableDbName()).buildListResultBean(cb, callReadList(cb));
    }
     ...
     * @exception com.example.dbflute.teeda.dbflute.allcommon.exception.EntityAlreadyDeletedException
     */
     ...
     * @param searchKey4Log Search-key for Logging. (NotNull)
     * @exception com.example.dbflute.teeda.dbflute.allcommon.exception.EntityAlreadyDeletedException
     * @exception com.example.dbflute.teeda.dbflute.allcommon.exception.EntityDuplicatedException
     */
