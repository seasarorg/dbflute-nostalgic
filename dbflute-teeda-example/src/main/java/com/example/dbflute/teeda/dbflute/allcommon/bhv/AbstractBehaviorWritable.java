package com.example.dbflute.teeda.dbflute.allcommon.bhv;
...
import com.example.dbflute.teeda.dbflute.allcommon.CommonColumnAutoSetupper;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.AbstractEntityCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.AbstractListEntityCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.InsertEntityCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.UpdateEntityCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.UpdateNonstrictEntityCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.DeleteEntityCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.DeleteNonstrictEntityCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.BatchInsertEntityCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.BatchUpdateEntityCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.BatchUpdateNonstrictEntityCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.BatchDeleteEntityCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.BatchDeleteNonstrictEntityCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.QueryDeleteCBCommand;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.core.command.QueryUpdateEntityCBCommand;
...
import com.example.dbflute.teeda.dbflute.allcommon.helper.MapStringBuilder;
import com.example.dbflute.teeda.dbflute.allcommon.helper.MapStringBuilderImpl;

import com.example.dbflute.teeda.dbflute.allcommon.bhv.batch.TokenFileReflectionOption;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.batch.TokenFileReflectionResult;
import com.example.dbflute.teeda.dbflute.allcommon.bhv.batch.TokenFileReflectionFailure;

import com.example.dbflute.teeda.dbflute.allcommon.helper.token.file.FileToken;
import com.example.dbflute.teeda.dbflute.allcommon.helper.token.file.FileTokenizingCallback;
import com.example.dbflute.teeda.dbflute.allcommon.helper.token.file.FileTokenizingRowResource;
import com.example.dbflute.teeda.dbflute.allcommon.helper.token.file.FileTokenizingHeaderInfo;
import com.example.dbflute.teeda.dbflute.allcommon.helper.token.file.FileTokenizingOption;
import com.example.dbflute.teeda.dbflute.allcommon.helper.token.file.impl.FileTokenImpl;
...
public abstract class AbstractBehaviorWritable extends AbstractBehaviorReadable implements BehaviorWritable {
     ...
     * @exception com.example.dbflute.teeda.dbflute.allcommon.exception.EntityAlreadyExistsException When the entity already exists. (Unique Constraint Violation)
     */
     ...
     * Modify.
     * @param entity Entity. (NotNull)
     * @exception com.example.dbflute.teeda.dbflute.allcommon.exception.EntityAlreadyUpdatedException When the entity has already been updated.
     ...
     * @exception com.example.dbflute.teeda.dbflute.allcommon.exception.EntityAlreadyExistsException When the entity already exists. (Unique Constraint Violation)
     */
    public void createOrModify(com.example.dbflute.teeda.dbflute.allcommon.Entity entity) {
     ...
     * @exception com.example.dbflute.teeda.dbflute.allcommon.exception.EntityAlreadyExistsException When the entity already exists. (Unique Constraint Violation)
     */
    public void createOrModifyNonstrict(com.example.dbflute.teeda.dbflute.allcommon.Entity entity) {
        assertEntityNotNull(entity);
     ...
     * @exception com.example.dbflute.teeda.dbflute.allcommon.exception.EntityDuplicatedException When the entity has been duplicated.
     */
    public void remove(com.example.dbflute.teeda.dbflute.allcommon.Entity entity) {
        assertEntityNotNull(entity);
        callRemove(entity);
    }
    ...
    protected <ENTITY extends Entity, CB_TYPE extends ConditionBean>
        ...
        if (!entity.hasPrimaryKeyValue()) {
            ...
            } catch (com.example.dbflute.teeda.dbflute.allcommon.exception.EntityAlreadyUpdatedException e) {
                if (e.getRows() == 0) {
                    exception = e;
                }
            } catch (com.example.dbflute.teeda.dbflute.allcommon.exception.EntityAlreadyDeletedException e) {
                exception = e;
     ...
     * @exception com.example.dbflute.teeda.dbflute.allcommon.exception.EntityAlreadyUpdatedException If s2dao's version is over 1.0.47 (contains 1.0.47).
     */
