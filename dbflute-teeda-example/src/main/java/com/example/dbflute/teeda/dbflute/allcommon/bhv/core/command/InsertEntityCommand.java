...
import com.example.dbflute.teeda.dbflute.allcommon.s2dao.internal.sqlcommand.InternalInsertAutoDynamicCommand;
...
public class InsertEntityCommand extends AbstractEntityCommand {
    ...
    protected SqlExecution createNonPrimaryInsertSqlExecution(BeanMetaData bmd) {
        ...
        for (com.example.dbflute.teeda.dbflute.allcommon.dbmeta.info.ColumnInfo columnInfo : columnInfoList) {
