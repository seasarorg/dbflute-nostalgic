package com.example.dbflute.teeda.dbflute.allcommon.cbean.outsidesql;
...
import com.example.dbflute.teeda.dbflute.allcommon.util.SimpleResourceUtil;
...
public class OutsideSqlContext {
    ...
    public static void throwOutsideSqlNotFoundException(String path) {
        ...
        msg = msg + "* * * * * * * * * */" + getLineSeparator();
        throw new com.example.dbflute.teeda.dbflute.allcommon.exception.OutsideSqlNotFoundException(msg);
    }
     ...
     * @exception com.example.dbflute.teeda.dbflute.allcommon.exception.OutsideSqlNotFoundException When the SQL is not found.
     */
