...
public class OutsideSqlEntityExecutor<PARAMETER_BEAN> {
     ...
     * @exception com.example.dbflute.teeda.dbflute.allcommon.exception.EntityDuplicatedException When the entity is duplicated.
     */
     ...
     * @return The selected entity. (Nullable)
     * @exception com.example.dbflute.teeda.dbflute.allcommon.exception.OutsideSqlNotFoundException When the outside-SQL is not found.
     * @exception com.example.dbflute.teeda.dbflute.allcommon.exception.EntityAlreadyDeletedException When the entity has already been deleted(not found).
     * @exception com.example.dbflute.teeda.dbflute.allcommon.exception.EntityDuplicatedException When the entity is duplicated.
     */
