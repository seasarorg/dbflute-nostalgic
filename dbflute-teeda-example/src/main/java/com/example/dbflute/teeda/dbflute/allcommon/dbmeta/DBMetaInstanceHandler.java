...
import com.example.dbflute.teeda.dbflute.allcommon.exception.DBMetaNotFoundException;
import com.example.dbflute.teeda.dbflute.allcommon.helper.StringKeyMap;
import com.example.dbflute.teeda.dbflute.allcommon.util.SimpleAssertUtil;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("MEMBER", "com.example.dbflute.teeda.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("MEMBER_ADDRESS", "com.example.dbflute.teeda.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("MEMBER_LOGIN", "com.example.dbflute.teeda.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("MEMBER_SECURITY", "com.example.dbflute.teeda.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("MEMBER_STATUS", "com.example.dbflute.teeda.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("MEMBER_WITHDRAWAL", "com.example.dbflute.teeda.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("PRODUCT", "com.example.dbflute.teeda.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("PRODUCT_STATUS", "com.example.dbflute.teeda.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("PURCHASE", "com.example.dbflute.teeda.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("VENDOR_CHECK", "com.example.dbflute.teeda.dbflute.bsentity.dbmeta.VendorCheckDbm");
        tmpMap.put("WITHDRAWAL_REASON", "com.example.dbflute.teeda.dbflute.bsentity.dbmeta.WithdrawalReasonDbm");
        tmpMap.put("SUMMARY_PRODUCT", "com.example.dbflute.teeda.dbflute.bsentity.dbmeta.SummaryProductDbm");
