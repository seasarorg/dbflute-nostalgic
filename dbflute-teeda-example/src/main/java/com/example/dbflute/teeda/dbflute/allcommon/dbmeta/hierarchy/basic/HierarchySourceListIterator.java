 ...
 */
public class HierarchySourceListIterator<SOURCE_ROW> implements com.example.dbflute.teeda.dbflute.allcommon.dbmeta.hierarchy.HierarchySourceIterator {
    ...
    protected com.example.dbflute.teeda.dbflute.allcommon.dbmeta.hierarchy.HierarchySourceRow currentSourceEntity;
    ...
    public com.example.dbflute.teeda.dbflute.allcommon.dbmeta.hierarchy.HierarchySourceRow next() {
        this.currentSourceEntity = this.sourceRowSetupper.setup(this.sourceBeanListIterator.next());
        return this.currentSourceEntity;
    }

    public com.example.dbflute.teeda.dbflute.allcommon.dbmeta.hierarchy.HierarchySourceRow current() {
        return this.currentSourceEntity;
    }
}