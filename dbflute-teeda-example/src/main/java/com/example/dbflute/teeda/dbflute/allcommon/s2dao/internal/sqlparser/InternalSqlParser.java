package com.example.dbflute.teeda.dbflute.allcommon.s2dao.internal.sqlparser;
...
import com.example.dbflute.teeda.dbflute.allcommon.cbean.MapParameterBean;
import com.example.dbflute.teeda.dbflute.allcommon.cbean.coption.LikeSearchOption;
import com.example.dbflute.teeda.dbflute.allcommon.exception.BindVariableCommentNotFoundPropertyException;
import com.example.dbflute.teeda.dbflute.allcommon.exception.BindVariableParameterNullValueException;
import com.example.dbflute.teeda.dbflute.allcommon.exception.EmbeddedValueCommentNotFoundPropertyException;
import com.example.dbflute.teeda.dbflute.allcommon.exception.EmbeddedValueParameterNullValueException;
import com.example.dbflute.teeda.dbflute.allcommon.exception.EndCommentNotFoundException;
import com.example.dbflute.teeda.dbflute.allcommon.exception.IfCommentConditionNotFoundException;
import com.example.dbflute.teeda.dbflute.allcommon.exception.IfCommentNotBooleanResultException;
import com.example.dbflute.teeda.dbflute.allcommon.exception.IfCommentWrongExpressionException;
import com.example.dbflute.teeda.dbflute.allcommon.exception.RequiredOptionNotFoundException;
import com.example.dbflute.teeda.dbflute.allcommon.s2dao.internal.util.InternalBindVariableUtil;
...
public class InternalSqlParser {
    ...
    public static String convertTwoWaySql2DisplaySql(String twoWaySql, String[] argNames
        ...
        {
            final InternalSqlParser parser = new InternalSqlParser(twoWaySql, false);
        ...
        return InternalBindVariableUtil.getCompleteSql(preparedSql, context.getBindVariables(), logDateFormat, logTimestampFormat);
    }
}
