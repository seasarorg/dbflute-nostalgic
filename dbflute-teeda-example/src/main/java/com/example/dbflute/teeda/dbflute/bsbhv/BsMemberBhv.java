...
import com.example.dbflute.teeda.dbflute.allcommon.bhv.setup.ConditionBeanSetupper;
...
import com.example.dbflute.teeda.dbflute.exbhv.*;
 ...
 */
public abstract class BsMemberBhv extends com.example.dbflute.teeda.dbflute.allcommon.bhv.AbstractBehaviorWritable {
    ...
    public List<MemberLogin> pulloutMemberLoginAsLatest(List<Member> memberList) {
        return helpPulloutInternally(memberList, new InternalPulloutCallback<Member, MemberLogin>() {
            public MemberLogin callbackGetForeignEntity(Member entity) { return entity.getMemberLoginAsLatest(); } });
    }
          /**
     ...
     * @exception com.example.dbflute.teeda.dbflute.allcommon.exception.BatchEntityAlreadyUpdatedException When the entity has already been updated. This exception extends ${glEntityAlreadyUpdateException}.
     */
