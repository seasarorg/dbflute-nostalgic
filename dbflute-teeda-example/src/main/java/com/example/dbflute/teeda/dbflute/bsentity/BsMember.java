...
public abstract class BsMember implements EntityDefinedCommonColumn, java.io.Serializable {
    ...
    //                                                Column
    //                                                ------
    /** MEMBER_ID: {PK : ID : NotNull : INTEGER : FK to MEMBER_LOGIN} */
    ...
    // /* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    //   Foreign Property = [memberLoginAsLatest]
    // * * * * * * * * */
    public static final int memberLoginAsLatest_RELNO = 1;
    public static final String memberLoginAsLatest_RELKEYS = "MEMBER_ID:MEMBER_ID";

    /** MEMBER_LOGIN as 'memberLoginAsLatest'. */
    protected MemberLogin _parentMemberLoginAsLatest;

    /**
     * MEMBER_LOGIN as 'memberLoginAsLatest'. {without lazy-load}
     * @return The entity of foreign property 'memberLoginAsLatest'. (Nullable: If the foreign key does not have 'NotNull' constraint, please check null.)
     */
    public MemberLogin getMemberLoginAsLatest() {
        return _parentMemberLoginAsLatest;
    }

    /**
     * MEMBER_LOGIN as 'memberLoginAsLatest'.
     * @param memberLoginAsLatest The entity of foreign property 'memberLoginAsLatest'. (Nullable)
     */
    public void setMemberLoginAsLatest(MemberLogin memberLoginAsLatest) {
        _parentMemberLoginAsLatest = memberLoginAsLatest;
    }
    ...
    /** The column annotation for S2Dao. {PK : ID : NotNull : INTEGER : FK to MEMBER_LOGIN} */
    public static final String memberId_COLUMN = "MEMBER_ID";

    /**
     * MEMBER_ID: {PK : ID : NotNull : INTEGER : FK to MEMBER_LOGIN} <br />
    ...
    public static final String formalizedDatetime_COLUMN = "FORMALIZED_DATETIME";

    /**
     * FORMALIZED_DATETIME: {TIMESTAMP} <br />
    ...
    public void setFormalizedDatetime(java.sql.Timestamp formalizedDatetime) {
        _modifiedProperties.addPropertyName("formalizedDatetime");
