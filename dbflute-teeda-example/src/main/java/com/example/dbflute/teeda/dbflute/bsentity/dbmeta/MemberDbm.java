...
public class MemberDbm extends AbstractDBMeta {
    ...
    protected ColumnInfo _columnFormalizedDatetime = cci("FORMALIZED_DATETIME", null, "formalizedDatetime", java.sql.Timestamp.class, false, null, null);
    protected ColumnInfo _columnBirthdate = cci("BIRTHDATE", null, "birthdate", java.util.Date.class, false, null, null);
    ...
    public ForeignInfo foreignMemberLoginAsLatest() {
        ...
        return cfi("memberLoginAsLatest", this, MemberLoginDbm.getInstance(), map, 1, true);
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.teeda.dbflute.exentity.Member"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.teeda.dbflute.cbean.bs.MemberCB"; }
    public String getDaoTypeName() { return "com.example.dbflute.teeda.dbflute.exdao.MemberDao"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.teeda.dbflute.exbhv.MemberBhv"; }
