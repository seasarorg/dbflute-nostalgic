package com.example.dbflute.teeda.dbflute.bsentity.dbmeta;

import java.util.List;
import java.util.Map;

import com.example.dbflute.teeda.dbflute.allcommon.Entity;
import com.example.dbflute.teeda.dbflute.allcommon.dbmeta.AbstractDBMeta;
import com.example.dbflute.teeda.dbflute.exentity.VendorCheck;
import com.example.dbflute.teeda.dbflute.allcommon.dbmeta.info.*;
...
public class VendorCheckDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected ColumnInfo _columnVendorCheckId = cci("VENDOR_CHECK_ID", null, "vendorCheckId", java.math.BigDecimal.class, true, 16, 0);
    protected ColumnInfo _columnDecimalDigit = cci("DECIMAL_DIGIT", null, "decimalDigit", java.math.BigDecimal.class, false, 5, 3);
    protected ColumnInfo _columnIntegerNonDigit = cci("INTEGER_NON_DIGIT", null, "integerNonDigit", java.math.BigDecimal.class, false, 5, 0);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.teeda.dbflute.exentity.VendorCheck"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.teeda.dbflute.cbean.bs.VendorCheckCB"; }
    public String getDaoTypeName() { return "com.example.dbflute.teeda.dbflute.exdao.VendorCheckDao"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.teeda.dbflute.exbhv.VendorCheckBhv"; }
    ...
    public static class EpsVendorCheckId implements Eps<VendorCheck> {
        public void setup(VendorCheck e, Object v) { e.setVendorCheckId((java.math.BigDecimal)v); }
    }
    ...
    public static class EpsIntegerNonDigit implements Eps<VendorCheck> {
        public void setup(VendorCheck e, Object v) { e.setIntegerNonDigit((java.math.BigDecimal)v); }
    }
