...
public abstract class AbstractBsMemberAddressCQ extends AbstractConditionQuery {
     ...
     */
    public void setValidBeginDate_FromTo(java.util.Date fromDate, java.util.Date toDate, com.example.dbflute.teeda.dbflute.allcommon.cbean.coption.FromToOption fromToOption) {
    ...
    public void setValidBeginDate_DateFromTo(java.util.Date fromDate, java.util.Date toDate) {
        setValidBeginDate_FromTo(fromDate, toDate, new com.example.dbflute.teeda.dbflute.allcommon.cbean.coption.DateFromToOption());
    }
     ...
     * @param fromToOption The option of from-to. (NotNull)
     */
    public void setValidEndDate_FromTo(java.util.Date fromDate, java.util.Date toDate, com.example.dbflute.teeda.dbflute.allcommon.cbean.coption.FromToOption fromToOption) {
    ...
    public void setValidEndDate_DateFromTo(java.util.Date fromDate, java.util.Date toDate) {
        setValidEndDate_FromTo(fromDate, toDate, new com.example.dbflute.teeda.dbflute.allcommon.cbean.coption.DateFromToOption());
    }
     ...
     */
    public void setAddress_LikeSearch(String address, com.example.dbflute.teeda.dbflute.allcommon.cbean.coption.LikeSearchOption likeSearchOption) {
     ...
     */
    public void setAddress_NotLikeSearch(String address, com.example.dbflute.teeda.dbflute.allcommon.cbean.coption.LikeSearchOption likeSearchOption) {
