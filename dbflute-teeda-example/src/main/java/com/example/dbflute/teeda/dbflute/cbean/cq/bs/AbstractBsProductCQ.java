...
public abstract class AbstractBsProductCQ extends AbstractConditionQuery {
     ...
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setProductHandleCode_LikeSearch(String productHandleCode, com.example.dbflute.teeda.dbflute.allcommon.cbean.coption.LikeSearchOption likeSearchOption) {
     ...
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setProductHandleCode_NotLikeSearch(String productHandleCode, com.example.dbflute.teeda.dbflute.allcommon.cbean.coption.LikeSearchOption likeSearchOption) {
    ...
    public abstract String keepProductStatusCode_InScopeSubQuery_ProductStatus(com.example.dbflute.teeda.dbflute.cbean.cq.ProductStatusCQ subQuery);
